...
pub type REFON_W<'a, const O: u8> = crate::BitWriter<'a, u16, REFCTL0_SPEC, bool, O>;
...
pub type REFOUT_W<'a, const O: u8> = crate::BitWriter<'a, u16, REFCTL0_SPEC, bool, O>;
...
pub type REFTCOFF_W<'a, const O: u8> = crate::BitWriter<'a, u16, REFCTL0_SPEC, bool, O>;
...
pub type REFVSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, REFCTL0_SPEC, u8, REFVSEL_A, 2, O>;
...
pub type REFMSTR_W<'a, const O: u8> = crate::BitWriter<'a, u16, REFCTL0_SPEC, bool, O>;
...
pub type REFGENACT_W<'a, const O: u8> = crate::BitWriter<'a, u16, REFCTL0_SPEC, bool, O>;
...
pub type REFBGACT_W<'a, const O: u8> = crate::BitWriter<'a, u16, REFCTL0_SPEC, bool, O>;
...
pub type REFGENBUSY_W<'a, const O: u8> = crate::BitWriter<'a, u16, REFCTL0_SPEC, bool, O>;
#[doc = "Field `BGMODE` reader - REF Bandgap mode"]
pub type BGMODE_R = crate::BitReader<bool>;
#[doc = "Field `BGMODE` writer - REF Bandgap mode"]
pub type BGMODE_W<'a, const O: u8> = crate::BitWriter<'a, u16, REFCTL0_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn refmstr(&mut self) -> REFMSTR_W<7> {
        REFMSTR_W::new(self)
    }
    #[doc = "Bit 8 - REF Reference generator active"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn refgenbusy(&mut self) -> REFGENBUSY_W<10> {
