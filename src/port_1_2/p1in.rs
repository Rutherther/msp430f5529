...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p1in0(&mut self) -> P1IN0_W<0> {
        P1IN0_W::new(self)
    }
    #[doc = "Bit 1 - P1IN1"]
    #[inline(always)]
    #[must_use]
    pub fn p1in1(&mut self) -> P1IN1_W<1> {
        P1IN1_W::new(self)
    }
    #[doc = "Bit 2 - P1IN2"]
    #[inline(always)]
    #[must_use]
    pub fn p1in2(&mut self) -> P1IN2_W<2> {
        P1IN2_W::new(self)
    }
    #[doc = "Bit 3 - P1IN3"]
    #[inline(always)]
    #[must_use]
    pub fn p1in3(&mut self) -> P1IN3_W<3> {
        P1IN3_W::new(self)
    }
    #[doc = "Bit 4 - P1IN4"]
    #[inline(always)]
    #[must_use]
    pub fn p1in4(&mut self) -> P1IN4_W<4> {
        P1IN4_W::new(self)
    }
    #[doc = "Bit 5 - P1IN5"]
    #[inline(always)]
    #[must_use]
    pub fn p1in5(&mut self) -> P1IN5_W<5> {
        P1IN5_W::new(self)
    }
    #[doc = "Bit 6 - P1IN6"]
    #[inline(always)]
    #[must_use]
    pub fn p1in6(&mut self) -> P1IN6_W<6> {
        P1IN6_W::new(self)
    }
    #[doc = "Bit 7 - P1IN7"]
    #[inline(always)]
    #[must_use]
    pub fn p1in7(&mut self) -> P1IN7_W<7> {
        P1IN7_W::new(self)
    }
