...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p1ren0(&mut self) -> P1REN0_W<0> {
        P1REN0_W::new(self)
    }
    #[doc = "Bit 1 - P1REN1"]
    #[inline(always)]
    #[must_use]
    pub fn p1ren1(&mut self) -> P1REN1_W<1> {
        P1REN1_W::new(self)
    }
    #[doc = "Bit 2 - P1REN2"]
    #[inline(always)]
    #[must_use]
    pub fn p1ren2(&mut self) -> P1REN2_W<2> {
        P1REN2_W::new(self)
    }
    #[doc = "Bit 3 - P1REN3"]
    #[inline(always)]
    #[must_use]
    pub fn p1ren3(&mut self) -> P1REN3_W<3> {
        P1REN3_W::new(self)
    }
    #[doc = "Bit 4 - P1REN4"]
    #[inline(always)]
    #[must_use]
    pub fn p1ren4(&mut self) -> P1REN4_W<4> {
        P1REN4_W::new(self)
    }
    #[doc = "Bit 5 - P1REN5"]
    #[inline(always)]
    #[must_use]
    pub fn p1ren5(&mut self) -> P1REN5_W<5> {
        P1REN5_W::new(self)
    }
    #[doc = "Bit 6 - P1REN6"]
    #[inline(always)]
    #[must_use]
    pub fn p1ren6(&mut self) -> P1REN6_W<6> {
        P1REN6_W::new(self)
    }
    #[doc = "Bit 7 - P1REN7"]
    #[inline(always)]
    #[must_use]
    pub fn p1ren7(&mut self) -> P1REN7_W<7> {
        P1REN7_W::new(self)
    }
