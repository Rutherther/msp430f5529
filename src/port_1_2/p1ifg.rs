...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p1ifg0(&mut self) -> P1IFG0_W<0> {
        P1IFG0_W::new(self)
    }
    #[doc = "Bit 1 - P1IFG1"]
    #[inline(always)]
    #[must_use]
    pub fn p1ifg1(&mut self) -> P1IFG1_W<1> {
        P1IFG1_W::new(self)
    }
    #[doc = "Bit 2 - P1IFG2"]
    #[inline(always)]
    #[must_use]
    pub fn p1ifg2(&mut self) -> P1IFG2_W<2> {
        P1IFG2_W::new(self)
    }
    #[doc = "Bit 3 - P1IFG3"]
    #[inline(always)]
    #[must_use]
    pub fn p1ifg3(&mut self) -> P1IFG3_W<3> {
        P1IFG3_W::new(self)
    }
    #[doc = "Bit 4 - P1IFG4"]
    #[inline(always)]
    #[must_use]
    pub fn p1ifg4(&mut self) -> P1IFG4_W<4> {
        P1IFG4_W::new(self)
    }
    #[doc = "Bit 5 - P1IFG5"]
    #[inline(always)]
    #[must_use]
    pub fn p1ifg5(&mut self) -> P1IFG5_W<5> {
        P1IFG5_W::new(self)
    }
    #[doc = "Bit 6 - P1IFG6"]
    #[inline(always)]
    #[must_use]
    pub fn p1ifg6(&mut self) -> P1IFG6_W<6> {
        P1IFG6_W::new(self)
    }
    #[doc = "Bit 7 - P1IFG7"]
    #[inline(always)]
    #[must_use]
    pub fn p1ifg7(&mut self) -> P1IFG7_W<7> {
        P1IFG7_W::new(self)
    }
