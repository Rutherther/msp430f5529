...
pub type P1IES0_R = crate::BitReader<bool>;
#[doc = "Field `P1IES0` writer - P1IES0"]
pub type P1IES0_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1IES_SPEC, bool, O>;
#[doc = "Field `P1IES1` reader - P1IES1"]
pub type P1IES1_R = crate::BitReader<bool>;
#[doc = "Field `P1IES1` writer - P1IES1"]
pub type P1IES1_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1IES_SPEC, bool, O>;
#[doc = "Field `P1IES2` reader - P1IES2"]
pub type P1IES2_R = crate::BitReader<bool>;
#[doc = "Field `P1IES2` writer - P1IES2"]
pub type P1IES2_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1IES_SPEC, bool, O>;
#[doc = "Field `P1IES3` reader - P1IES3"]
pub type P1IES3_R = crate::BitReader<bool>;
#[doc = "Field `P1IES3` writer - P1IES3"]
pub type P1IES3_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1IES_SPEC, bool, O>;
#[doc = "Field `P1IES4` reader - P1IES4"]
pub type P1IES4_R = crate::BitReader<bool>;
#[doc = "Field `P1IES4` writer - P1IES4"]
pub type P1IES4_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1IES_SPEC, bool, O>;
#[doc = "Field `P1IES5` reader - P1IES5"]
pub type P1IES5_R = crate::BitReader<bool>;
#[doc = "Field `P1IES5` writer - P1IES5"]
pub type P1IES5_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1IES_SPEC, bool, O>;
#[doc = "Field `P1IES6` reader - P1IES6"]
pub type P1IES6_R = crate::BitReader<bool>;
#[doc = "Field `P1IES6` writer - P1IES6"]
pub type P1IES6_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1IES_SPEC, bool, O>;
#[doc = "Field `P1IES7` reader - P1IES7"]
pub type P1IES7_R = crate::BitReader<bool>;
#[doc = "Field `P1IES7` writer - P1IES7"]
pub type P1IES7_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1IES_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - P1IES0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p1ies0(&mut self) -> P1IES0_W<0> {
        P1IES0_W::new(self)
    }
    #[doc = "Bit 1 - P1IES1"]
    #[inline(always)]
    #[must_use]
    pub fn p1ies1(&mut self) -> P1IES1_W<1> {
        P1IES1_W::new(self)
    }
    #[doc = "Bit 2 - P1IES2"]
    #[inline(always)]
    #[must_use]
    pub fn p1ies2(&mut self) -> P1IES2_W<2> {
        P1IES2_W::new(self)
    }
    #[doc = "Bit 3 - P1IES3"]
    #[inline(always)]
    #[must_use]
    pub fn p1ies3(&mut self) -> P1IES3_W<3> {
        P1IES3_W::new(self)
    }
    #[doc = "Bit 4 - P1IES4"]
    #[inline(always)]
    #[must_use]
    pub fn p1ies4(&mut self) -> P1IES4_W<4> {
        P1IES4_W::new(self)
    }
    #[doc = "Bit 5 - P1IES5"]
    #[inline(always)]
    #[must_use]
    pub fn p1ies5(&mut self) -> P1IES5_W<5> {
        P1IES5_W::new(self)
    }
    #[doc = "Bit 6 - P1IES6"]
    #[inline(always)]
    #[must_use]
    pub fn p1ies6(&mut self) -> P1IES6_W<6> {
        P1IES6_W::new(self)
    }
    #[doc = "Bit 7 - P1IES7"]
    #[inline(always)]
    #[must_use]
    pub fn p1ies7(&mut self) -> P1IES7_W<7> {
        P1IES7_W::new(self)
    }
