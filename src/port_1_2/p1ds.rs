...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p1ds0(&mut self) -> P1DS0_W<0> {
        P1DS0_W::new(self)
    }
    #[doc = "Bit 1 - P1DS1"]
    #[inline(always)]
    #[must_use]
    pub fn p1ds1(&mut self) -> P1DS1_W<1> {
        P1DS1_W::new(self)
    }
    #[doc = "Bit 2 - P1DS2"]
    #[inline(always)]
    #[must_use]
    pub fn p1ds2(&mut self) -> P1DS2_W<2> {
        P1DS2_W::new(self)
    }
    #[doc = "Bit 3 - P1DS3"]
    #[inline(always)]
    #[must_use]
    pub fn p1ds3(&mut self) -> P1DS3_W<3> {
        P1DS3_W::new(self)
    }
    #[doc = "Bit 4 - P1DS4"]
    #[inline(always)]
    #[must_use]
    pub fn p1ds4(&mut self) -> P1DS4_W<4> {
        P1DS4_W::new(self)
    }
    #[doc = "Bit 5 - P1DS5"]
    #[inline(always)]
    #[must_use]
    pub fn p1ds5(&mut self) -> P1DS5_W<5> {
        P1DS5_W::new(self)
    }
    #[doc = "Bit 6 - P1DS6"]
    #[inline(always)]
    #[must_use]
    pub fn p1ds6(&mut self) -> P1DS6_W<6> {
        P1DS6_W::new(self)
    }
    #[doc = "Bit 7 - P1DS7"]
    #[inline(always)]
    #[must_use]
    pub fn p1ds7(&mut self) -> P1DS7_W<7> {
        P1DS7_W::new(self)
    }
