...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p2ds0(&mut self) -> P2DS0_W<0> {
        P2DS0_W::new(self)
    }
    #[doc = "Bit 1 - P2DS1"]
    #[inline(always)]
    #[must_use]
    pub fn p2ds1(&mut self) -> P2DS1_W<1> {
        P2DS1_W::new(self)
    }
    #[doc = "Bit 2 - P2DS2"]
    #[inline(always)]
    #[must_use]
    pub fn p2ds2(&mut self) -> P2DS2_W<2> {
        P2DS2_W::new(self)
    }
    #[doc = "Bit 3 - P2DS3"]
    #[inline(always)]
    #[must_use]
    pub fn p2ds3(&mut self) -> P2DS3_W<3> {
        P2DS3_W::new(self)
    }
    #[doc = "Bit 4 - P2DS4"]
    #[inline(always)]
    #[must_use]
    pub fn p2ds4(&mut self) -> P2DS4_W<4> {
        P2DS4_W::new(self)
    }
    #[doc = "Bit 5 - P2DS5"]
    #[inline(always)]
    #[must_use]
    pub fn p2ds5(&mut self) -> P2DS5_W<5> {
        P2DS5_W::new(self)
    }
    #[doc = "Bit 6 - P2DS6"]
    #[inline(always)]
    #[must_use]
    pub fn p2ds6(&mut self) -> P2DS6_W<6> {
        P2DS6_W::new(self)
    }
    #[doc = "Bit 7 - P2DS7"]
    #[inline(always)]
    #[must_use]
    pub fn p2ds7(&mut self) -> P2DS7_W<7> {
        P2DS7_W::new(self)
    }
