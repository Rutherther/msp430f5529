...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p2sel0(&mut self) -> P2SEL0_W<0> {
        P2SEL0_W::new(self)
    }
    #[doc = "Bit 1 - P2SEL1"]
    #[inline(always)]
    #[must_use]
    pub fn p2sel1(&mut self) -> P2SEL1_W<1> {
        P2SEL1_W::new(self)
    }
    #[doc = "Bit 2 - P2SEL2"]
    #[inline(always)]
    #[must_use]
    pub fn p2sel2(&mut self) -> P2SEL2_W<2> {
        P2SEL2_W::new(self)
    }
    #[doc = "Bit 3 - P2SEL3"]
    #[inline(always)]
    #[must_use]
    pub fn p2sel3(&mut self) -> P2SEL3_W<3> {
        P2SEL3_W::new(self)
    }
    #[doc = "Bit 4 - P2SEL4"]
    #[inline(always)]
    #[must_use]
    pub fn p2sel4(&mut self) -> P2SEL4_W<4> {
        P2SEL4_W::new(self)
    }
    #[doc = "Bit 5 - P2SEL5"]
    #[inline(always)]
    #[must_use]
    pub fn p2sel5(&mut self) -> P2SEL5_W<5> {
        P2SEL5_W::new(self)
    }
    #[doc = "Bit 6 - P2SEL6"]
    #[inline(always)]
    #[must_use]
    pub fn p2sel6(&mut self) -> P2SEL6_W<6> {
        P2SEL6_W::new(self)
    }
    #[doc = "Bit 7 - P2SEL7"]
    #[inline(always)]
    #[must_use]
    pub fn p2sel7(&mut self) -> P2SEL7_W<7> {
        P2SEL7_W::new(self)
    }
