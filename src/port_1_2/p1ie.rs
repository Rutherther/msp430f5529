...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p1ie0(&mut self) -> P1IE0_W<0> {
        P1IE0_W::new(self)
    }
    #[doc = "Bit 1 - P1IE1"]
    #[inline(always)]
    #[must_use]
    pub fn p1ie1(&mut self) -> P1IE1_W<1> {
        P1IE1_W::new(self)
    }
    #[doc = "Bit 2 - P1IE2"]
    #[inline(always)]
    #[must_use]
    pub fn p1ie2(&mut self) -> P1IE2_W<2> {
        P1IE2_W::new(self)
    }
    #[doc = "Bit 3 - P1IE3"]
    #[inline(always)]
    #[must_use]
    pub fn p1ie3(&mut self) -> P1IE3_W<3> {
        P1IE3_W::new(self)
    }
    #[doc = "Bit 4 - P1IE4"]
    #[inline(always)]
    #[must_use]
    pub fn p1ie4(&mut self) -> P1IE4_W<4> {
        P1IE4_W::new(self)
    }
    #[doc = "Bit 5 - P1IE5"]
    #[inline(always)]
    #[must_use]
    pub fn p1ie5(&mut self) -> P1IE5_W<5> {
        P1IE5_W::new(self)
    }
    #[doc = "Bit 6 - P1IE6"]
    #[inline(always)]
    #[must_use]
    pub fn p1ie6(&mut self) -> P1IE6_W<6> {
        P1IE6_W::new(self)
    }
    #[doc = "Bit 7 - P1IE7"]
    #[inline(always)]
    #[must_use]
    pub fn p1ie7(&mut self) -> P1IE7_W<7> {
        P1IE7_W::new(self)
    }
