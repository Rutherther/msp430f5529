...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p2ifg0(&mut self) -> P2IFG0_W<0> {
        P2IFG0_W::new(self)
    }
    #[doc = "Bit 1 - P2IFG1"]
    #[inline(always)]
    #[must_use]
    pub fn p2ifg1(&mut self) -> P2IFG1_W<1> {
        P2IFG1_W::new(self)
    }
    #[doc = "Bit 2 - P2IFG2"]
    #[inline(always)]
    #[must_use]
    pub fn p2ifg2(&mut self) -> P2IFG2_W<2> {
        P2IFG2_W::new(self)
    }
    #[doc = "Bit 3 - P2IFG3"]
    #[inline(always)]
    #[must_use]
    pub fn p2ifg3(&mut self) -> P2IFG3_W<3> {
        P2IFG3_W::new(self)
    }
    #[doc = "Bit 4 - P2IFG4"]
    #[inline(always)]
    #[must_use]
    pub fn p2ifg4(&mut self) -> P2IFG4_W<4> {
        P2IFG4_W::new(self)
    }
    #[doc = "Bit 5 - P2IFG5"]
    #[inline(always)]
    #[must_use]
    pub fn p2ifg5(&mut self) -> P2IFG5_W<5> {
        P2IFG5_W::new(self)
    }
    #[doc = "Bit 6 - P2IFG6"]
    #[inline(always)]
    #[must_use]
    pub fn p2ifg6(&mut self) -> P2IFG6_W<6> {
        P2IFG6_W::new(self)
    }
    #[doc = "Bit 7 - P2IFG7"]
    #[inline(always)]
    #[must_use]
    pub fn p2ifg7(&mut self) -> P2IFG7_W<7> {
        P2IFG7_W::new(self)
    }
