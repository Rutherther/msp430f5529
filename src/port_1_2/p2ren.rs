...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p2ren0(&mut self) -> P2REN0_W<0> {
        P2REN0_W::new(self)
    }
    #[doc = "Bit 1 - P2REN1"]
    #[inline(always)]
    #[must_use]
    pub fn p2ren1(&mut self) -> P2REN1_W<1> {
        P2REN1_W::new(self)
    }
    #[doc = "Bit 2 - P2REN2"]
    #[inline(always)]
    #[must_use]
    pub fn p2ren2(&mut self) -> P2REN2_W<2> {
        P2REN2_W::new(self)
    }
    #[doc = "Bit 3 - P2REN3"]
    #[inline(always)]
    #[must_use]
    pub fn p2ren3(&mut self) -> P2REN3_W<3> {
        P2REN3_W::new(self)
    }
    #[doc = "Bit 4 - P2REN4"]
    #[inline(always)]
    #[must_use]
    pub fn p2ren4(&mut self) -> P2REN4_W<4> {
        P2REN4_W::new(self)
    }
    #[doc = "Bit 5 - P2REN5"]
    #[inline(always)]
    #[must_use]
    pub fn p2ren5(&mut self) -> P2REN5_W<5> {
        P2REN5_W::new(self)
    }
    #[doc = "Bit 6 - P2REN6"]
    #[inline(always)]
    #[must_use]
    pub fn p2ren6(&mut self) -> P2REN6_W<6> {
        P2REN6_W::new(self)
    }
    #[doc = "Bit 7 - P2REN7"]
    #[inline(always)]
    #[must_use]
    pub fn p2ren7(&mut self) -> P2REN7_W<7> {
        P2REN7_W::new(self)
    }
