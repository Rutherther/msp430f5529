...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p1sel1(&mut self) -> P1SEL1_W<1> {
        P1SEL1_W::new(self)
    }
    #[doc = "Bit 2 - P1SEL2"]
    #[inline(always)]
    #[must_use]
    pub fn p1sel2(&mut self) -> P1SEL2_W<2> {
        P1SEL2_W::new(self)
    }
    #[doc = "Bit 3 - P1SEL3"]
    #[inline(always)]
    #[must_use]
    pub fn p1sel3(&mut self) -> P1SEL3_W<3> {
        P1SEL3_W::new(self)
    }
    #[doc = "Bit 4 - P1SEL4"]
    #[inline(always)]
    #[must_use]
    pub fn p1sel4(&mut self) -> P1SEL4_W<4> {
        P1SEL4_W::new(self)
    }
    #[doc = "Bit 5 - P1SEL5"]
    #[inline(always)]
    #[must_use]
    pub fn p1sel5(&mut self) -> P1SEL5_W<5> {
        P1SEL5_W::new(self)
    }
    #[doc = "Bit 6 - P1SEL6"]
    #[inline(always)]
    #[must_use]
    pub fn p1sel6(&mut self) -> P1SEL6_W<6> {
        P1SEL6_W::new(self)
    }
    #[doc = "Bit 7 - P1SEL7"]
    #[inline(always)]
    #[must_use]
    pub fn p1sel7(&mut self) -> P1SEL7_W<7> {
        P1SEL7_W::new(self)
    }
