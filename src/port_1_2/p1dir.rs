...
pub type P1DIR0_R = crate::BitReader<bool>;
#[doc = "Field `P1DIR0` writer - P1DIR0"]
pub type P1DIR0_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1DIR_SPEC, bool, O>;
#[doc = "Field `P1DIR1` reader - P1DIR1"]
pub type P1DIR1_R = crate::BitReader<bool>;
#[doc = "Field `P1DIR1` writer - P1DIR1"]
pub type P1DIR1_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1DIR_SPEC, bool, O>;
#[doc = "Field `P1DIR2` reader - P1DIR2"]
pub type P1DIR2_R = crate::BitReader<bool>;
#[doc = "Field `P1DIR2` writer - P1DIR2"]
pub type P1DIR2_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1DIR_SPEC, bool, O>;
#[doc = "Field `P1DIR3` reader - P1DIR3"]
pub type P1DIR3_R = crate::BitReader<bool>;
#[doc = "Field `P1DIR3` writer - P1DIR3"]
pub type P1DIR3_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1DIR_SPEC, bool, O>;
#[doc = "Field `P1DIR4` reader - P1DIR4"]
pub type P1DIR4_R = crate::BitReader<bool>;
#[doc = "Field `P1DIR4` writer - P1DIR4"]
pub type P1DIR4_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1DIR_SPEC, bool, O>;
#[doc = "Field `P1DIR5` reader - P1DIR5"]
pub type P1DIR5_R = crate::BitReader<bool>;
#[doc = "Field `P1DIR5` writer - P1DIR5"]
pub type P1DIR5_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1DIR_SPEC, bool, O>;
#[doc = "Field `P1DIR6` reader - P1DIR6"]
pub type P1DIR6_R = crate::BitReader<bool>;
#[doc = "Field `P1DIR6` writer - P1DIR6"]
pub type P1DIR6_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1DIR_SPEC, bool, O>;
#[doc = "Field `P1DIR7` reader - P1DIR7"]
pub type P1DIR7_R = crate::BitReader<bool>;
#[doc = "Field `P1DIR7` writer - P1DIR7"]
pub type P1DIR7_W<'a, const O: u8> = crate::BitWriter<'a, u8, P1DIR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - P1DIR0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p1dir0(&mut self) -> P1DIR0_W<0> {
        P1DIR0_W::new(self)
    }
    #[doc = "Bit 1 - P1DIR1"]
    #[inline(always)]
    #[must_use]
    pub fn p1dir1(&mut self) -> P1DIR1_W<1> {
        P1DIR1_W::new(self)
    }
    #[doc = "Bit 2 - P1DIR2"]
    #[inline(always)]
    #[must_use]
    pub fn p1dir2(&mut self) -> P1DIR2_W<2> {
        P1DIR2_W::new(self)
    }
    #[doc = "Bit 3 - P1DIR3"]
    #[inline(always)]
    #[must_use]
    pub fn p1dir3(&mut self) -> P1DIR3_W<3> {
        P1DIR3_W::new(self)
    }
    #[doc = "Bit 4 - P1DIR4"]
    #[inline(always)]
    #[must_use]
    pub fn p1dir4(&mut self) -> P1DIR4_W<4> {
        P1DIR4_W::new(self)
    }
    #[doc = "Bit 5 - P1DIR5"]
    #[inline(always)]
    #[must_use]
    pub fn p1dir5(&mut self) -> P1DIR5_W<5> {
        P1DIR5_W::new(self)
    }
    #[doc = "Bit 6 - P1DIR6"]
    #[inline(always)]
    #[must_use]
    pub fn p1dir6(&mut self) -> P1DIR6_W<6> {
        P1DIR6_W::new(self)
    }
    #[doc = "Bit 7 - P1DIR7"]
    #[inline(always)]
    #[must_use]
    pub fn p1dir7(&mut self) -> P1DIR7_W<7> {
        P1DIR7_W::new(self)
    }
