...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p2ie0(&mut self) -> P2IE0_W<0> {
        P2IE0_W::new(self)
    }
    #[doc = "Bit 1 - P2IE1"]
    #[inline(always)]
    #[must_use]
    pub fn p2ie1(&mut self) -> P2IE1_W<1> {
        P2IE1_W::new(self)
    }
    #[doc = "Bit 2 - P2IE2"]
    #[inline(always)]
    #[must_use]
    pub fn p2ie2(&mut self) -> P2IE2_W<2> {
        P2IE2_W::new(self)
    }
    #[doc = "Bit 3 - P2IE3"]
    #[inline(always)]
    #[must_use]
    pub fn p2ie3(&mut self) -> P2IE3_W<3> {
        P2IE3_W::new(self)
    }
    #[doc = "Bit 4 - P2IE4"]
    #[inline(always)]
    #[must_use]
    pub fn p2ie4(&mut self) -> P2IE4_W<4> {
        P2IE4_W::new(self)
    }
    #[doc = "Bit 5 - P2IE5"]
    #[inline(always)]
    #[must_use]
    pub fn p2ie5(&mut self) -> P2IE5_W<5> {
        P2IE5_W::new(self)
    }
    #[doc = "Bit 6 - P2IE6"]
    #[inline(always)]
    #[must_use]
    pub fn p2ie6(&mut self) -> P2IE6_W<6> {
        P2IE6_W::new(self)
    }
    #[doc = "Bit 7 - P2IE7"]
    #[inline(always)]
    #[must_use]
    pub fn p2ie7(&mut self) -> P2IE7_W<7> {
        P2IE7_W::new(self)
    }
