...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p2dir0(&mut self) -> P2DIR0_W<0> {
        P2DIR0_W::new(self)
    }
    #[doc = "Bit 1 - P2DIR1"]
    #[inline(always)]
    #[must_use]
    pub fn p2dir1(&mut self) -> P2DIR1_W<1> {
        P2DIR1_W::new(self)
    }
    #[doc = "Bit 2 - P2DIR2"]
    #[inline(always)]
    #[must_use]
    pub fn p2dir2(&mut self) -> P2DIR2_W<2> {
        P2DIR2_W::new(self)
    }
    #[doc = "Bit 3 - P2DIR3"]
    #[inline(always)]
    #[must_use]
    pub fn p2dir3(&mut self) -> P2DIR3_W<3> {
        P2DIR3_W::new(self)
    }
    #[doc = "Bit 4 - P2DIR4"]
    #[inline(always)]
    #[must_use]
    pub fn p2dir4(&mut self) -> P2DIR4_W<4> {
        P2DIR4_W::new(self)
    }
    #[doc = "Bit 5 - P2DIR5"]
    #[inline(always)]
    #[must_use]
    pub fn p2dir5(&mut self) -> P2DIR5_W<5> {
        P2DIR5_W::new(self)
    }
    #[doc = "Bit 6 - P2DIR6"]
    #[inline(always)]
    #[must_use]
    pub fn p2dir6(&mut self) -> P2DIR6_W<6> {
        P2DIR6_W::new(self)
    }
    #[doc = "Bit 7 - P2DIR7"]
    #[inline(always)]
    #[must_use]
    pub fn p2dir7(&mut self) -> P2DIR7_W<7> {
        P2DIR7_W::new(self)
    }
