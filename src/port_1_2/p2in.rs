...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p2in0(&mut self) -> P2IN0_W<0> {
        P2IN0_W::new(self)
    }
    #[doc = "Bit 1 - P2IN1"]
    #[inline(always)]
    #[must_use]
    pub fn p2in1(&mut self) -> P2IN1_W<1> {
        P2IN1_W::new(self)
    }
    #[doc = "Bit 2 - P2IN2"]
    #[inline(always)]
    #[must_use]
    pub fn p2in2(&mut self) -> P2IN2_W<2> {
        P2IN2_W::new(self)
    }
    #[doc = "Bit 3 - P2IN3"]
    #[inline(always)]
    #[must_use]
    pub fn p2in3(&mut self) -> P2IN3_W<3> {
        P2IN3_W::new(self)
    }
    #[doc = "Bit 4 - P2IN4"]
    #[inline(always)]
    #[must_use]
    pub fn p2in4(&mut self) -> P2IN4_W<4> {
        P2IN4_W::new(self)
    }
    #[doc = "Bit 5 - P2IN5"]
    #[inline(always)]
    #[must_use]
    pub fn p2in5(&mut self) -> P2IN5_W<5> {
        P2IN5_W::new(self)
    }
    #[doc = "Bit 6 - P2IN6"]
    #[inline(always)]
    #[must_use]
    pub fn p2in6(&mut self) -> P2IN6_W<6> {
        P2IN6_W::new(self)
    }
    #[doc = "Bit 7 - P2IN7"]
    #[inline(always)]
    #[must_use]
    pub fn p2in7(&mut self) -> P2IN7_W<7> {
        P2IN7_W::new(self)
    }
