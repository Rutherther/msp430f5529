...
pub type ADC12ENC_R = crate::BitReader<bool>;
#[doc = "Field `ADC12ENC` writer - ADC12 Enable Conversion"]
pub type ADC12ENC_W<'a, const O: u8> = crate::BitWriter<'a, u16, ADC12CTL0_SPEC, bool, O>;
...
pub type ADC12REFON_R = crate::BitReader<bool>;
#[doc = "Field `ADC12REFON` writer - ADC12 Reference on"]
pub type ADC12REFON_W<'a, const O: u8> = crate::BitWriter<'a, u16, ADC12CTL0_SPEC, bool, O>;
#[doc = "Field `ADC12REF2_5V` reader - ADC12 Ref 0:1.5V / 1:2.5V"]
pub type ADC12REF2_5V_R = crate::BitReader<bool>;
#[doc = "Field `ADC12REF2_5V` writer - ADC12 Ref 0:1.5V / 1:2.5V"]
pub type ADC12REF2_5V_W<'a, const O: u8> = crate::BitWriter<'a, u16, ADC12CTL0_SPEC, bool, O>;
#[doc = "Field `ADC12MSC` reader - ADC12 Multiple SampleConversion"]
pub type ADC12MSC_R = crate::BitReader<bool>;
#[doc = "Field `ADC12MSC` writer - ADC12 Multiple SampleConversion"]
pub type ADC12MSC_W<'a, const O: u8> = crate::BitWriter<'a, u16, ADC12CTL0_SPEC, bool, O>;
#[doc = "Field `ADC12SHT0` reader - ADC12 Sample Hold 0 Select Bit: 0"]
pub type ADC12SHT0_R = crate::FieldReader<u8, ADC12SHT0_A>;
...
pub type ADC12SHT0_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, ADC12CTL0_SPEC, u8, ADC12SHT0_A, 4, O>;
impl<'a, const O: u8> ADC12SHT0_W<'a, O> {
    #[doc = "ADC12 Sample Hold 0 Select Bit: 0"]
    #[inline(always)]
...
pub type ADC12SHT1_R = crate::FieldReader<u8, ADC12SHT1_A>;
...
pub type ADC12SHT1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, ADC12CTL0_SPEC, u8, ADC12SHT1_A, 4, O>;
impl<'a, const O: u8> ADC12SHT1_W<'a, O> {
    #[doc = "ADC12 Sample Hold 1 Select Bit: 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc12enc(&mut self) -> ADC12ENC_W<1> {
        ADC12ENC_W::new(self)
    }
    #[doc = "Bit 2 - ADC12 Timer Overflow interrupt enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc12refon(&mut self) -> ADC12REFON_W<5> {
        ADC12REFON_W::new(self)
    }
    #[doc = "Bit 6 - ADC12 Ref 0:1.5V / 1:2.5V"]
    #[inline(always)]
    #[must_use]
    pub fn adc12ref2_5v(&mut self) -> ADC12REF2_5V_W<6> {
        ADC12REF2_5V_W::new(self)
    }
    #[doc = "Bit 7 - ADC12 Multiple SampleConversion"]
    #[inline(always)]
    #[must_use]
    pub fn adc12msc(&mut self) -> ADC12MSC_W<7> {
        ADC12MSC_W::new(self)
    }
    #[doc = "Bits 8:11 - ADC12 Sample Hold 0 Select Bit: 0"]
    #[inline(always)]
    #[must_use]
    pub fn adc12sht0(&mut self) -> ADC12SHT0_W<8> {
        ADC12SHT0_W::new(self)
    }
    #[doc = "Bits 12:15 - ADC12 Sample Hold 1 Select Bit: 0"]
    #[inline(always)]
    #[must_use]
    pub fn adc12sht1(&mut self) -> ADC12SHT1_W<12> {
        ADC12SHT1_W::new(self)
    }
