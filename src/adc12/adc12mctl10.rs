...
pub type ADC12INCH_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, ADC12MCTL10_SPEC, u8, ADC12INCH_A, 4, O>;
...
pub type ADC12SREF_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, ADC12MCTL10_SPEC, u8, ADC12SREF_A, 3, O>;
...
pub type ADC12EOS_W<'a, const O: u8> = crate::BitWriter<'a, u8, ADC12MCTL10_SPEC, bool, O>;
impl R {
