...
pub type UCRXIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB1IE_SPEC, bool, O>;
...
pub type UCTXIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB1IE_SPEC, bool, O>;
...
pub type UCSTTIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB1IE_SPEC, bool, O>;
...
pub type UCSTPIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB1IE_SPEC, bool, O>;
...
pub type UCALIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB1IE_SPEC, bool, O>;
...
pub type UCNACKIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB1IE_SPEC, bool, O>;
impl R {
