...
pub type SYSRIVECT_W<'a, const O: u8> = crate::BitWriter<'a, u16, SYSCTL_SPEC, bool, O>;
...
pub type SYSPMMPE_W<'a, const O: u8> = crate::BitWriter<'a, u16, SYSCTL_SPEC, bool, O>;
...
pub type SYSBSLIND_W<'a, const O: u8> = crate::BitWriter<'a, u16, SYSCTL_SPEC, bool, O>;
...
pub type SYSJTAGPIN_W<'a, const O: u8> = crate::BitWriter<'a, u16, SYSCTL_SPEC, bool, O>;
impl R {
