...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pjdir0(&mut self) -> PJDIR0_W<0> {
        PJDIR0_W::new(self)
    }
    #[doc = "Bit 1 - PJDIR1"]
    #[inline(always)]
    #[must_use]
    pub fn pjdir1(&mut self) -> PJDIR1_W<1> {
        PJDIR1_W::new(self)
    }
    #[doc = "Bit 2 - PJDIR2"]
    #[inline(always)]
    #[must_use]
    pub fn pjdir2(&mut self) -> PJDIR2_W<2> {
        PJDIR2_W::new(self)
    }
    #[doc = "Bit 3 - PJDIR3"]
    #[inline(always)]
    #[must_use]
    pub fn pjdir3(&mut self) -> PJDIR3_W<3> {
        PJDIR3_W::new(self)
    }
