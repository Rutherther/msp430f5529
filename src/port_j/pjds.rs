...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pjds0(&mut self) -> PJDS0_W<0> {
        PJDS0_W::new(self)
    }
    #[doc = "Bit 1 - PJDS1"]
    #[inline(always)]
    #[must_use]
    pub fn pjds1(&mut self) -> PJDS1_W<1> {
        PJDS1_W::new(self)
    }
    #[doc = "Bit 2 - PJDS2"]
    #[inline(always)]
    #[must_use]
    pub fn pjds2(&mut self) -> PJDS2_W<2> {
        PJDS2_W::new(self)
    }
    #[doc = "Bit 3 - PJDS3"]
    #[inline(always)]
    #[must_use]
    pub fn pjds3(&mut self) -> PJDS3_W<3> {
        PJDS3_W::new(self)
    }
