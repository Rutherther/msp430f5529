...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pjin0(&mut self) -> PJIN0_W<0> {
        PJIN0_W::new(self)
    }
    #[doc = "Bit 1 - PJIN1"]
    #[inline(always)]
    #[must_use]
    pub fn pjin1(&mut self) -> PJIN1_W<1> {
        PJIN1_W::new(self)
    }
    #[doc = "Bit 2 - PJIN2"]
    #[inline(always)]
    #[must_use]
    pub fn pjin2(&mut self) -> PJIN2_W<2> {
        PJIN2_W::new(self)
    }
    #[doc = "Bit 3 - PJIN3"]
    #[inline(always)]
    #[must_use]
    pub fn pjin3(&mut self) -> PJIN3_W<3> {
        PJIN3_W::new(self)
    }
