...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p3sel1(&mut self) -> P3SEL1_W<1> {
        P3SEL1_W::new(self)
    }
    #[doc = "Bit 2 - P3SEL2"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel2(&mut self) -> P3SEL2_W<2> {
        P3SEL2_W::new(self)
    }
    #[doc = "Bit 3 - P3SEL3"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel3(&mut self) -> P3SEL3_W<3> {
        P3SEL3_W::new(self)
    }
    #[doc = "Bit 4 - P3SEL4"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel4(&mut self) -> P3SEL4_W<4> {
        P3SEL4_W::new(self)
    }
    #[doc = "Bit 5 - P3SEL5"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel5(&mut self) -> P3SEL5_W<5> {
        P3SEL5_W::new(self)
    }
    #[doc = "Bit 6 - P3SEL6"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel6(&mut self) -> P3SEL6_W<6> {
        P3SEL6_W::new(self)
    }
    #[doc = "Bit 7 - P3SEL7"]
    #[inline(always)]
    #[must_use]
    pub fn p3sel7(&mut self) -> P3SEL7_W<7> {
        P3SEL7_W::new(self)
    }
