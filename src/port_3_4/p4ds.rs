...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p4ds0(&mut self) -> P4DS0_W<0> {
        P4DS0_W::new(self)
    }
    #[doc = "Bit 1 - P4DS1"]
    #[inline(always)]
    #[must_use]
    pub fn p4ds1(&mut self) -> P4DS1_W<1> {
        P4DS1_W::new(self)
    }
    #[doc = "Bit 2 - P4DS2"]
    #[inline(always)]
    #[must_use]
    pub fn p4ds2(&mut self) -> P4DS2_W<2> {
        P4DS2_W::new(self)
    }
    #[doc = "Bit 3 - P4DS3"]
    #[inline(always)]
    #[must_use]
    pub fn p4ds3(&mut self) -> P4DS3_W<3> {
        P4DS3_W::new(self)
    }
    #[doc = "Bit 4 - P4DS4"]
    #[inline(always)]
    #[must_use]
    pub fn p4ds4(&mut self) -> P4DS4_W<4> {
        P4DS4_W::new(self)
    }
    #[doc = "Bit 5 - P4DS5"]
    #[inline(always)]
    #[must_use]
    pub fn p4ds5(&mut self) -> P4DS5_W<5> {
        P4DS5_W::new(self)
    }
    #[doc = "Bit 6 - P4DS6"]
    #[inline(always)]
    #[must_use]
    pub fn p4ds6(&mut self) -> P4DS6_W<6> {
        P4DS6_W::new(self)
    }
    #[doc = "Bit 7 - P4DS7"]
    #[inline(always)]
    #[must_use]
    pub fn p4ds7(&mut self) -> P4DS7_W<7> {
        P4DS7_W::new(self)
    }
