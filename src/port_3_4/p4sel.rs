...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p4sel0(&mut self) -> P4SEL0_W<0> {
        P4SEL0_W::new(self)
    }
    #[doc = "Bit 1 - P4SEL1"]
    #[inline(always)]
    #[must_use]
    pub fn p4sel1(&mut self) -> P4SEL1_W<1> {
        P4SEL1_W::new(self)
    }
    #[doc = "Bit 2 - P4SEL2"]
    #[inline(always)]
    #[must_use]
    pub fn p4sel2(&mut self) -> P4SEL2_W<2> {
        P4SEL2_W::new(self)
    }
    #[doc = "Bit 3 - P4SEL3"]
    #[inline(always)]
    #[must_use]
    pub fn p4sel3(&mut self) -> P4SEL3_W<3> {
        P4SEL3_W::new(self)
    }
    #[doc = "Bit 4 - P4SEL4"]
    #[inline(always)]
    #[must_use]
    pub fn p4sel4(&mut self) -> P4SEL4_W<4> {
        P4SEL4_W::new(self)
    }
    #[doc = "Bit 5 - P4SEL5"]
    #[inline(always)]
    #[must_use]
    pub fn p4sel5(&mut self) -> P4SEL5_W<5> {
        P4SEL5_W::new(self)
    }
    #[doc = "Bit 6 - P4SEL6"]
    #[inline(always)]
    #[must_use]
    pub fn p4sel6(&mut self) -> P4SEL6_W<6> {
        P4SEL6_W::new(self)
    }
    #[doc = "Bit 7 - P4SEL7"]
    #[inline(always)]
    #[must_use]
    pub fn p4sel7(&mut self) -> P4SEL7_W<7> {
        P4SEL7_W::new(self)
    }
