...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p4in0(&mut self) -> P4IN0_W<0> {
        P4IN0_W::new(self)
    }
    #[doc = "Bit 1 - P4IN1"]
    #[inline(always)]
    #[must_use]
    pub fn p4in1(&mut self) -> P4IN1_W<1> {
        P4IN1_W::new(self)
    }
    #[doc = "Bit 2 - P4IN2"]
    #[inline(always)]
    #[must_use]
    pub fn p4in2(&mut self) -> P4IN2_W<2> {
        P4IN2_W::new(self)
    }
    #[doc = "Bit 3 - P4IN3"]
    #[inline(always)]
    #[must_use]
    pub fn p4in3(&mut self) -> P4IN3_W<3> {
        P4IN3_W::new(self)
    }
    #[doc = "Bit 4 - P4IN4"]
    #[inline(always)]
    #[must_use]
    pub fn p4in4(&mut self) -> P4IN4_W<4> {
        P4IN4_W::new(self)
    }
    #[doc = "Bit 5 - P4IN5"]
    #[inline(always)]
    #[must_use]
    pub fn p4in5(&mut self) -> P4IN5_W<5> {
        P4IN5_W::new(self)
    }
    #[doc = "Bit 6 - P4IN6"]
    #[inline(always)]
    #[must_use]
    pub fn p4in6(&mut self) -> P4IN6_W<6> {
        P4IN6_W::new(self)
    }
    #[doc = "Bit 7 - P4IN7"]
    #[inline(always)]
    #[must_use]
    pub fn p4in7(&mut self) -> P4IN7_W<7> {
        P4IN7_W::new(self)
    }
