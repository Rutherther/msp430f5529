...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p3out0(&mut self) -> P3OUT0_W<0> {
        P3OUT0_W::new(self)
    }
    #[doc = "Bit 1 - P3OUT1"]
    #[inline(always)]
    #[must_use]
    pub fn p3out1(&mut self) -> P3OUT1_W<1> {
        P3OUT1_W::new(self)
    }
    #[doc = "Bit 2 - P3OUT2"]
    #[inline(always)]
    #[must_use]
    pub fn p3out2(&mut self) -> P3OUT2_W<2> {
        P3OUT2_W::new(self)
    }
    #[doc = "Bit 3 - P3OUT3"]
    #[inline(always)]
    #[must_use]
    pub fn p3out3(&mut self) -> P3OUT3_W<3> {
        P3OUT3_W::new(self)
    }
    #[doc = "Bit 4 - P3OUT4"]
    #[inline(always)]
    #[must_use]
    pub fn p3out4(&mut self) -> P3OUT4_W<4> {
        P3OUT4_W::new(self)
    }
    #[doc = "Bit 5 - P3OUT5"]
    #[inline(always)]
    #[must_use]
    pub fn p3out5(&mut self) -> P3OUT5_W<5> {
        P3OUT5_W::new(self)
    }
    #[doc = "Bit 6 - P3OUT6"]
    #[inline(always)]
    #[must_use]
    pub fn p3out6(&mut self) -> P3OUT6_W<6> {
        P3OUT6_W::new(self)
    }
    #[doc = "Bit 7 - P3OUT7"]
    #[inline(always)]
    #[must_use]
    pub fn p3out7(&mut self) -> P3OUT7_W<7> {
        P3OUT7_W::new(self)
    }
