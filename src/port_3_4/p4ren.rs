...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p4ren0(&mut self) -> P4REN0_W<0> {
        P4REN0_W::new(self)
    }
    #[doc = "Bit 1 - P4REN1"]
    #[inline(always)]
    #[must_use]
    pub fn p4ren1(&mut self) -> P4REN1_W<1> {
        P4REN1_W::new(self)
    }
    #[doc = "Bit 2 - P4REN2"]
    #[inline(always)]
    #[must_use]
    pub fn p4ren2(&mut self) -> P4REN2_W<2> {
        P4REN2_W::new(self)
    }
    #[doc = "Bit 3 - P4REN3"]
    #[inline(always)]
    #[must_use]
    pub fn p4ren3(&mut self) -> P4REN3_W<3> {
        P4REN3_W::new(self)
    }
    #[doc = "Bit 4 - P4REN4"]
    #[inline(always)]
    #[must_use]
    pub fn p4ren4(&mut self) -> P4REN4_W<4> {
        P4REN4_W::new(self)
    }
    #[doc = "Bit 5 - P4REN5"]
    #[inline(always)]
    #[must_use]
    pub fn p4ren5(&mut self) -> P4REN5_W<5> {
        P4REN5_W::new(self)
    }
    #[doc = "Bit 6 - P4REN6"]
    #[inline(always)]
    #[must_use]
    pub fn p4ren6(&mut self) -> P4REN6_W<6> {
        P4REN6_W::new(self)
    }
    #[doc = "Bit 7 - P4REN7"]
    #[inline(always)]
    #[must_use]
    pub fn p4ren7(&mut self) -> P4REN7_W<7> {
        P4REN7_W::new(self)
    }
