...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p3ren0(&mut self) -> P3REN0_W<0> {
        P3REN0_W::new(self)
    }
    #[doc = "Bit 1 - P3REN1"]
    #[inline(always)]
    #[must_use]
    pub fn p3ren1(&mut self) -> P3REN1_W<1> {
        P3REN1_W::new(self)
    }
    #[doc = "Bit 2 - P3REN2"]
    #[inline(always)]
    #[must_use]
    pub fn p3ren2(&mut self) -> P3REN2_W<2> {
        P3REN2_W::new(self)
    }
    #[doc = "Bit 3 - P3REN3"]
    #[inline(always)]
    #[must_use]
    pub fn p3ren3(&mut self) -> P3REN3_W<3> {
        P3REN3_W::new(self)
    }
    #[doc = "Bit 4 - P3REN4"]
    #[inline(always)]
    #[must_use]
    pub fn p3ren4(&mut self) -> P3REN4_W<4> {
        P3REN4_W::new(self)
    }
    #[doc = "Bit 5 - P3REN5"]
    #[inline(always)]
    #[must_use]
    pub fn p3ren5(&mut self) -> P3REN5_W<5> {
        P3REN5_W::new(self)
    }
    #[doc = "Bit 6 - P3REN6"]
    #[inline(always)]
    #[must_use]
    pub fn p3ren6(&mut self) -> P3REN6_W<6> {
        P3REN6_W::new(self)
    }
    #[doc = "Bit 7 - P3REN7"]
    #[inline(always)]
    #[must_use]
    pub fn p3ren7(&mut self) -> P3REN7_W<7> {
        P3REN7_W::new(self)
    }
