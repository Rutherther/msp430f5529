...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p3in0(&mut self) -> P3IN0_W<0> {
        P3IN0_W::new(self)
    }
    #[doc = "Bit 1 - P3IN1"]
    #[inline(always)]
    #[must_use]
    pub fn p3in1(&mut self) -> P3IN1_W<1> {
        P3IN1_W::new(self)
    }
    #[doc = "Bit 2 - P3IN2"]
    #[inline(always)]
    #[must_use]
    pub fn p3in2(&mut self) -> P3IN2_W<2> {
        P3IN2_W::new(self)
    }
    #[doc = "Bit 3 - P3IN3"]
    #[inline(always)]
    #[must_use]
    pub fn p3in3(&mut self) -> P3IN3_W<3> {
        P3IN3_W::new(self)
    }
    #[doc = "Bit 4 - P3IN4"]
    #[inline(always)]
    #[must_use]
    pub fn p3in4(&mut self) -> P3IN4_W<4> {
        P3IN4_W::new(self)
    }
    #[doc = "Bit 5 - P3IN5"]
    #[inline(always)]
    #[must_use]
    pub fn p3in5(&mut self) -> P3IN5_W<5> {
        P3IN5_W::new(self)
    }
    #[doc = "Bit 6 - P3IN6"]
    #[inline(always)]
    #[must_use]
    pub fn p3in6(&mut self) -> P3IN6_W<6> {
        P3IN6_W::new(self)
    }
    #[doc = "Bit 7 - P3IN7"]
    #[inline(always)]
    #[must_use]
    pub fn p3in7(&mut self) -> P3IN7_W<7> {
        P3IN7_W::new(self)
    }
