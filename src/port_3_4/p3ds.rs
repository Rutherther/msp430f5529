...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p3ds0(&mut self) -> P3DS0_W<0> {
        P3DS0_W::new(self)
    }
    #[doc = "Bit 1 - P3DS1"]
    #[inline(always)]
    #[must_use]
    pub fn p3ds1(&mut self) -> P3DS1_W<1> {
        P3DS1_W::new(self)
    }
    #[doc = "Bit 2 - P3DS2"]
    #[inline(always)]
    #[must_use]
    pub fn p3ds2(&mut self) -> P3DS2_W<2> {
        P3DS2_W::new(self)
    }
    #[doc = "Bit 3 - P3DS3"]
    #[inline(always)]
    #[must_use]
    pub fn p3ds3(&mut self) -> P3DS3_W<3> {
        P3DS3_W::new(self)
    }
    #[doc = "Bit 4 - P3DS4"]
    #[inline(always)]
    #[must_use]
    pub fn p3ds4(&mut self) -> P3DS4_W<4> {
        P3DS4_W::new(self)
    }
    #[doc = "Bit 5 - P3DS5"]
    #[inline(always)]
    #[must_use]
    pub fn p3ds5(&mut self) -> P3DS5_W<5> {
        P3DS5_W::new(self)
    }
    #[doc = "Bit 6 - P3DS6"]
    #[inline(always)]
    #[must_use]
    pub fn p3ds6(&mut self) -> P3DS6_W<6> {
        P3DS6_W::new(self)
    }
    #[doc = "Bit 7 - P3DS7"]
    #[inline(always)]
    #[must_use]
    pub fn p3ds7(&mut self) -> P3DS7_W<7> {
        P3DS7_W::new(self)
    }
