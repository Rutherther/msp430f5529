...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p4dir0(&mut self) -> P4DIR0_W<0> {
        P4DIR0_W::new(self)
    }
    #[doc = "Bit 1 - P4DIR1"]
    #[inline(always)]
    #[must_use]
    pub fn p4dir1(&mut self) -> P4DIR1_W<1> {
        P4DIR1_W::new(self)
    }
    #[doc = "Bit 2 - P4DIR2"]
    #[inline(always)]
    #[must_use]
    pub fn p4dir2(&mut self) -> P4DIR2_W<2> {
        P4DIR2_W::new(self)
    }
    #[doc = "Bit 3 - P4DIR3"]
    #[inline(always)]
    #[must_use]
    pub fn p4dir3(&mut self) -> P4DIR3_W<3> {
        P4DIR3_W::new(self)
    }
    #[doc = "Bit 4 - P4DIR4"]
    #[inline(always)]
    #[must_use]
    pub fn p4dir4(&mut self) -> P4DIR4_W<4> {
        P4DIR4_W::new(self)
    }
    #[doc = "Bit 5 - P4DIR5"]
    #[inline(always)]
    #[must_use]
    pub fn p4dir5(&mut self) -> P4DIR5_W<5> {
        P4DIR5_W::new(self)
    }
    #[doc = "Bit 6 - P4DIR6"]
    #[inline(always)]
    #[must_use]
    pub fn p4dir6(&mut self) -> P4DIR6_W<6> {
        P4DIR6_W::new(self)
    }
    #[doc = "Bit 7 - P4DIR7"]
    #[inline(always)]
    #[must_use]
    pub fn p4dir7(&mut self) -> P4DIR7_W<7> {
        P4DIR7_W::new(self)
    }
