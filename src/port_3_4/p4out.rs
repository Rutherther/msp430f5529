...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p4out0(&mut self) -> P4OUT0_W<0> {
        P4OUT0_W::new(self)
    }
    #[doc = "Bit 1 - P4OUT1"]
    #[inline(always)]
    #[must_use]
    pub fn p4out1(&mut self) -> P4OUT1_W<1> {
        P4OUT1_W::new(self)
    }
    #[doc = "Bit 2 - P4OUT2"]
    #[inline(always)]
    #[must_use]
    pub fn p4out2(&mut self) -> P4OUT2_W<2> {
        P4OUT2_W::new(self)
    }
    #[doc = "Bit 3 - P4OUT3"]
    #[inline(always)]
    #[must_use]
    pub fn p4out3(&mut self) -> P4OUT3_W<3> {
        P4OUT3_W::new(self)
    }
    #[doc = "Bit 4 - P4OUT4"]
    #[inline(always)]
    #[must_use]
    pub fn p4out4(&mut self) -> P4OUT4_W<4> {
        P4OUT4_W::new(self)
    }
    #[doc = "Bit 5 - P4OUT5"]
    #[inline(always)]
    #[must_use]
    pub fn p4out5(&mut self) -> P4OUT5_W<5> {
        P4OUT5_W::new(self)
    }
    #[doc = "Bit 6 - P4OUT6"]
    #[inline(always)]
    #[must_use]
    pub fn p4out6(&mut self) -> P4OUT6_W<6> {
        P4OUT6_W::new(self)
    }
    #[doc = "Bit 7 - P4OUT7"]
    #[inline(always)]
    #[must_use]
    pub fn p4out7(&mut self) -> P4OUT7_W<7> {
        P4OUT7_W::new(self)
    }
