...
pub type VPE_W<'a, const O: u8> = crate::BitWriter<'a, u16, FCTL4_SPEC, bool, O>;
...
pub type LOCKINFO_W<'a, const O: u8> = crate::BitWriter<'a, u16, FCTL4_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lockinfo(&mut self) -> LOCKINFO_W<7> {
        LOCKINFO_W::new(self)
    }
