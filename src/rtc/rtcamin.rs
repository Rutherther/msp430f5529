...
pub type MINUTES0_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCAMIN_SPEC, bool, O>;
...
pub type MINUTES1_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCAMIN_SPEC, bool, O>;
...
pub type MINUTES2_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCAMIN_SPEC, bool, O>;
...
pub type MINUTES3_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCAMIN_SPEC, bool, O>;
...
pub type MINUTES4_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCAMIN_SPEC, bool, O>;
...
pub type MINUTES5_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCAMIN_SPEC, bool, O>;
...
pub type MINUTES6_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCAMIN_SPEC, bool, O>;
...
pub type RTCAE_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCAMIN_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn minutes0(&mut self) -> MINUTES0_W<0> {
        MINUTES0_W::new(self)
    }
    #[doc = "Bit 1 - Real Time Clock Minutes Bit: 1"]
    #[inline(always)]
    #[must_use]
    pub fn minutes1(&mut self) -> MINUTES1_W<1> {
        MINUTES1_W::new(self)
    }
    #[doc = "Bit 2 - Real Time Clock Minutes Bit: 2"]
    #[inline(always)]
    #[must_use]
    pub fn minutes2(&mut self) -> MINUTES2_W<2> {
        MINUTES2_W::new(self)
    }
    #[doc = "Bit 3 - Real Time Clock Minutes Bit: 3"]
    #[inline(always)]
    #[must_use]
    pub fn minutes3(&mut self) -> MINUTES3_W<3> {
        MINUTES3_W::new(self)
    }
    #[doc = "Bit 4 - Real Time Clock Minutes Bit: 4"]
    #[inline(always)]
    #[must_use]
    pub fn minutes4(&mut self) -> MINUTES4_W<4> {
        MINUTES4_W::new(self)
    }
    #[doc = "Bit 5 - Real Time Clock Minutes Bit: 5"]
    #[inline(always)]
    #[must_use]
    pub fn minutes5(&mut self) -> MINUTES5_W<5> {
        MINUTES5_W::new(self)
    }
    #[doc = "Bit 6 - Real Time Clock Minutes Bit: 6"]
    #[inline(always)]
    #[must_use]
    pub fn minutes6(&mut self) -> MINUTES6_W<6> {
        MINUTES6_W::new(self)
    }
    #[doc = "Bit 7 - Real Time Clock Alarm enable"]
    #[inline(always)]
