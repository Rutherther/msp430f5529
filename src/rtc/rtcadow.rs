...
pub type DOW0_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADOW_SPEC, bool, O>;
...
pub type DOW1_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADOW_SPEC, bool, O>;
...
pub type DOW2_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADOW_SPEC, bool, O>;
...
pub type DOW3_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADOW_SPEC, bool, O>;
...
pub type DOW4_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADOW_SPEC, bool, O>;
...
pub type DOW5_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADOW_SPEC, bool, O>;
...
pub type DOW6_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADOW_SPEC, bool, O>;
...
pub type RTCAE_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADOW_SPEC, bool, O>;
impl R {
