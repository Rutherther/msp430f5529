...
pub type HOUR0_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCHOUR_SPEC, bool, O>;
...
pub type HOUR1_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCHOUR_SPEC, bool, O>;
...
pub type HOUR2_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCHOUR_SPEC, bool, O>;
...
pub type HOUR3_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCHOUR_SPEC, bool, O>;
...
pub type HOUR4_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCHOUR_SPEC, bool, O>;
...
pub type HOUR5_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCHOUR_SPEC, bool, O>;
...
pub type HOUR6_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCHOUR_SPEC, bool, O>;
impl R {
