...
pub type DAY0_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADAY_SPEC, bool, O>;
...
pub type DAY1_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADAY_SPEC, bool, O>;
...
pub type DAY2_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADAY_SPEC, bool, O>;
...
pub type DAY3_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADAY_SPEC, bool, O>;
...
pub type DAY4_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADAY_SPEC, bool, O>;
...
pub type DAY5_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADAY_SPEC, bool, O>;
...
pub type DAY6_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADAY_SPEC, bool, O>;
...
pub type RTCAE_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCADAY_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn day0(&mut self) -> DAY0_W<0> {
        DAY0_W::new(self)
    }
    #[doc = "Bit 1 - Real Time Clock Day Bit: 1"]
    #[inline(always)]
    #[must_use]
    pub fn day1(&mut self) -> DAY1_W<1> {
        DAY1_W::new(self)
    }
    #[doc = "Bit 2 - Real Time Clock Day Bit: 2"]
    #[inline(always)]
    #[must_use]
    pub fn day2(&mut self) -> DAY2_W<2> {
        DAY2_W::new(self)
    }
    #[doc = "Bit 3 - Real Time Clock Day Bit: 3"]
    #[inline(always)]
    #[must_use]
    pub fn day3(&mut self) -> DAY3_W<3> {
        DAY3_W::new(self)
    }
    #[doc = "Bit 4 - Real Time Clock Day Bit: 4"]
    #[inline(always)]
    #[must_use]
    pub fn day4(&mut self) -> DAY4_W<4> {
        DAY4_W::new(self)
    }
    #[doc = "Bit 5 - Real Time Clock Day Bit: 5"]
    #[inline(always)]
    #[must_use]
    pub fn day5(&mut self) -> DAY5_W<5> {
        DAY5_W::new(self)
    }
    #[doc = "Bit 6 - Real Time Clock Day Bit: 6"]
    #[inline(always)]
    #[must_use]
    pub fn day6(&mut self) -> DAY6_W<6> {
        DAY6_W::new(self)
    }
    #[doc = "Bit 7 - Real Time Clock Alarm enable"]
    #[inline(always)]
