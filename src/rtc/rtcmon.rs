...
pub type MONTH0_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMON_SPEC, bool, O>;
...
pub type MONTH1_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMON_SPEC, bool, O>;
...
pub type MONTH2_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMON_SPEC, bool, O>;
...
pub type MONTH3_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMON_SPEC, bool, O>;
...
pub type MONTH4_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMON_SPEC, bool, O>;
...
pub type MONTH5_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMON_SPEC, bool, O>;
...
pub type MONTH6_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMON_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn month0(&mut self) -> MONTH0_W<0> {
        MONTH0_W::new(self)
    }
    #[doc = "Bit 1 - Real Time Clock Month Bit: 1"]
    #[inline(always)]
    #[must_use]
    pub fn month1(&mut self) -> MONTH1_W<1> {
        MONTH1_W::new(self)
    }
    #[doc = "Bit 2 - Real Time Clock Month Bit: 2"]
    #[inline(always)]
    #[must_use]
    pub fn month2(&mut self) -> MONTH2_W<2> {
        MONTH2_W::new(self)
    }
    #[doc = "Bit 3 - Real Time Clock Month Bit: 3"]
    #[inline(always)]
    #[must_use]
    pub fn month3(&mut self) -> MONTH3_W<3> {
        MONTH3_W::new(self)
    }
    #[doc = "Bit 4 - Real Time Clock Month Bit: 4"]
    #[inline(always)]
    #[must_use]
    pub fn month4(&mut self) -> MONTH4_W<4> {
        MONTH4_W::new(self)
    }
    #[doc = "Bit 5 - Real Time Clock Month Bit: 5"]
    #[inline(always)]
    #[must_use]
    pub fn month5(&mut self) -> MONTH5_W<5> {
        MONTH5_W::new(self)
    }
    #[doc = "Bit 6 - Real Time Clock Month Bit: 6"]
    #[inline(always)]
    #[must_use]
    pub fn month6(&mut self) -> MONTH6_W<6> {
        MONTH6_W::new(self)
    }
