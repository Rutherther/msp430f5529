...
pub type MINUTES0_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMIN_SPEC, bool, O>;
...
pub type MINUTES1_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMIN_SPEC, bool, O>;
...
pub type MINUTES2_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMIN_SPEC, bool, O>;
...
pub type MINUTES3_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMIN_SPEC, bool, O>;
...
pub type MINUTES4_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMIN_SPEC, bool, O>;
...
pub type MINUTES5_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMIN_SPEC, bool, O>;
...
pub type MINUTES6_W<'a, const O: u8> = crate::BitWriter<'a, u8, RTCMIN_SPEC, bool, O>;
impl R {
