...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p6in0(&mut self) -> P6IN0_W<0> {
        P6IN0_W::new(self)
    }
    #[doc = "Bit 1 - P6IN1"]
    #[inline(always)]
    #[must_use]
    pub fn p6in1(&mut self) -> P6IN1_W<1> {
        P6IN1_W::new(self)
    }
    #[doc = "Bit 2 - P6IN2"]
    #[inline(always)]
    #[must_use]
    pub fn p6in2(&mut self) -> P6IN2_W<2> {
        P6IN2_W::new(self)
    }
    #[doc = "Bit 3 - P6IN3"]
    #[inline(always)]
    #[must_use]
    pub fn p6in3(&mut self) -> P6IN3_W<3> {
        P6IN3_W::new(self)
    }
    #[doc = "Bit 4 - P6IN4"]
    #[inline(always)]
    #[must_use]
    pub fn p6in4(&mut self) -> P6IN4_W<4> {
        P6IN4_W::new(self)
    }
    #[doc = "Bit 5 - P6IN5"]
    #[inline(always)]
    #[must_use]
    pub fn p6in5(&mut self) -> P6IN5_W<5> {
        P6IN5_W::new(self)
    }
    #[doc = "Bit 6 - P6IN6"]
    #[inline(always)]
    #[must_use]
    pub fn p6in6(&mut self) -> P6IN6_W<6> {
        P6IN6_W::new(self)
    }
    #[doc = "Bit 7 - P6IN7"]
    #[inline(always)]
    #[must_use]
    pub fn p6in7(&mut self) -> P6IN7_W<7> {
        P6IN7_W::new(self)
    }
