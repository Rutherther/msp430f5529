...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p6ren0(&mut self) -> P6REN0_W<0> {
        P6REN0_W::new(self)
    }
    #[doc = "Bit 1 - P6REN1"]
    #[inline(always)]
    #[must_use]
    pub fn p6ren1(&mut self) -> P6REN1_W<1> {
        P6REN1_W::new(self)
    }
    #[doc = "Bit 2 - P6REN2"]
    #[inline(always)]
    #[must_use]
    pub fn p6ren2(&mut self) -> P6REN2_W<2> {
        P6REN2_W::new(self)
    }
    #[doc = "Bit 3 - P6REN3"]
    #[inline(always)]
    #[must_use]
    pub fn p6ren3(&mut self) -> P6REN3_W<3> {
        P6REN3_W::new(self)
    }
    #[doc = "Bit 4 - P6REN4"]
    #[inline(always)]
    #[must_use]
    pub fn p6ren4(&mut self) -> P6REN4_W<4> {
        P6REN4_W::new(self)
    }
    #[doc = "Bit 5 - P6REN5"]
    #[inline(always)]
    #[must_use]
    pub fn p6ren5(&mut self) -> P6REN5_W<5> {
        P6REN5_W::new(self)
    }
    #[doc = "Bit 6 - P6REN6"]
    #[inline(always)]
    #[must_use]
    pub fn p6ren6(&mut self) -> P6REN6_W<6> {
        P6REN6_W::new(self)
    }
    #[doc = "Bit 7 - P6REN7"]
    #[inline(always)]
    #[must_use]
    pub fn p6ren7(&mut self) -> P6REN7_W<7> {
        P6REN7_W::new(self)
    }
