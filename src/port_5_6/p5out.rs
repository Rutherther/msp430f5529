...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p5out0(&mut self) -> P5OUT0_W<0> {
        P5OUT0_W::new(self)
    }
    #[doc = "Bit 1 - P5OUT1"]
    #[inline(always)]
    #[must_use]
    pub fn p5out1(&mut self) -> P5OUT1_W<1> {
        P5OUT1_W::new(self)
    }
    #[doc = "Bit 2 - P5OUT2"]
    #[inline(always)]
    #[must_use]
    pub fn p5out2(&mut self) -> P5OUT2_W<2> {
        P5OUT2_W::new(self)
    }
    #[doc = "Bit 3 - P5OUT3"]
    #[inline(always)]
    #[must_use]
    pub fn p5out3(&mut self) -> P5OUT3_W<3> {
        P5OUT3_W::new(self)
    }
    #[doc = "Bit 4 - P5OUT4"]
    #[inline(always)]
    #[must_use]
    pub fn p5out4(&mut self) -> P5OUT4_W<4> {
        P5OUT4_W::new(self)
    }
    #[doc = "Bit 5 - P5OUT5"]
    #[inline(always)]
    #[must_use]
    pub fn p5out5(&mut self) -> P5OUT5_W<5> {
        P5OUT5_W::new(self)
    }
    #[doc = "Bit 6 - P5OUT6"]
    #[inline(always)]
    #[must_use]
    pub fn p5out6(&mut self) -> P5OUT6_W<6> {
        P5OUT6_W::new(self)
    }
    #[doc = "Bit 7 - P5OUT7"]
    #[inline(always)]
    #[must_use]
    pub fn p5out7(&mut self) -> P5OUT7_W<7> {
        P5OUT7_W::new(self)
    }
