...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p6sel0(&mut self) -> P6SEL0_W<0> {
        P6SEL0_W::new(self)
    }
    #[doc = "Bit 1 - P6SEL1"]
    #[inline(always)]
    #[must_use]
    pub fn p6sel1(&mut self) -> P6SEL1_W<1> {
        P6SEL1_W::new(self)
    }
    #[doc = "Bit 2 - P6SEL2"]
    #[inline(always)]
    #[must_use]
    pub fn p6sel2(&mut self) -> P6SEL2_W<2> {
        P6SEL2_W::new(self)
    }
    #[doc = "Bit 3 - P6SEL3"]
    #[inline(always)]
    #[must_use]
    pub fn p6sel3(&mut self) -> P6SEL3_W<3> {
        P6SEL3_W::new(self)
    }
    #[doc = "Bit 4 - P6SEL4"]
    #[inline(always)]
    #[must_use]
    pub fn p6sel4(&mut self) -> P6SEL4_W<4> {
        P6SEL4_W::new(self)
    }
    #[doc = "Bit 5 - P6SEL5"]
    #[inline(always)]
    #[must_use]
    pub fn p6sel5(&mut self) -> P6SEL5_W<5> {
        P6SEL5_W::new(self)
    }
    #[doc = "Bit 6 - P6SEL6"]
    #[inline(always)]
    #[must_use]
    pub fn p6sel6(&mut self) -> P6SEL6_W<6> {
        P6SEL6_W::new(self)
    }
    #[doc = "Bit 7 - P6SEL7"]
    #[inline(always)]
    #[must_use]
    pub fn p6sel7(&mut self) -> P6SEL7_W<7> {
        P6SEL7_W::new(self)
    }
