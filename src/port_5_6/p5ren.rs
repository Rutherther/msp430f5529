...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p5ren0(&mut self) -> P5REN0_W<0> {
        P5REN0_W::new(self)
    }
    #[doc = "Bit 1 - P5REN1"]
    #[inline(always)]
    #[must_use]
    pub fn p5ren1(&mut self) -> P5REN1_W<1> {
        P5REN1_W::new(self)
    }
    #[doc = "Bit 2 - P5REN2"]
    #[inline(always)]
    #[must_use]
    pub fn p5ren2(&mut self) -> P5REN2_W<2> {
        P5REN2_W::new(self)
    }
    #[doc = "Bit 3 - P5REN3"]
    #[inline(always)]
    #[must_use]
    pub fn p5ren3(&mut self) -> P5REN3_W<3> {
        P5REN3_W::new(self)
    }
    #[doc = "Bit 4 - P5REN4"]
    #[inline(always)]
    #[must_use]
    pub fn p5ren4(&mut self) -> P5REN4_W<4> {
        P5REN4_W::new(self)
    }
    #[doc = "Bit 5 - P5REN5"]
    #[inline(always)]
    #[must_use]
    pub fn p5ren5(&mut self) -> P5REN5_W<5> {
        P5REN5_W::new(self)
    }
    #[doc = "Bit 6 - P5REN6"]
    #[inline(always)]
    #[must_use]
    pub fn p5ren6(&mut self) -> P5REN6_W<6> {
        P5REN6_W::new(self)
    }
    #[doc = "Bit 7 - P5REN7"]
    #[inline(always)]
    #[must_use]
    pub fn p5ren7(&mut self) -> P5REN7_W<7> {
        P5REN7_W::new(self)
    }
