...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p5ds0(&mut self) -> P5DS0_W<0> {
        P5DS0_W::new(self)
    }
    #[doc = "Bit 1 - P5DS1"]
    #[inline(always)]
    #[must_use]
    pub fn p5ds1(&mut self) -> P5DS1_W<1> {
        P5DS1_W::new(self)
    }
    #[doc = "Bit 2 - P5DS2"]
    #[inline(always)]
    #[must_use]
    pub fn p5ds2(&mut self) -> P5DS2_W<2> {
        P5DS2_W::new(self)
    }
    #[doc = "Bit 3 - P5DS3"]
    #[inline(always)]
    #[must_use]
    pub fn p5ds3(&mut self) -> P5DS3_W<3> {
        P5DS3_W::new(self)
    }
    #[doc = "Bit 4 - P5DS4"]
    #[inline(always)]
    #[must_use]
    pub fn p5ds4(&mut self) -> P5DS4_W<4> {
        P5DS4_W::new(self)
    }
    #[doc = "Bit 5 - P5DS5"]
    #[inline(always)]
    #[must_use]
    pub fn p5ds5(&mut self) -> P5DS5_W<5> {
        P5DS5_W::new(self)
    }
    #[doc = "Bit 6 - P5DS6"]
    #[inline(always)]
    #[must_use]
    pub fn p5ds6(&mut self) -> P5DS6_W<6> {
        P5DS6_W::new(self)
    }
    #[doc = "Bit 7 - P5DS7"]
    #[inline(always)]
    #[must_use]
    pub fn p5ds7(&mut self) -> P5DS7_W<7> {
        P5DS7_W::new(self)
    }
