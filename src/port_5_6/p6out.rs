...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p6out0(&mut self) -> P6OUT0_W<0> {
        P6OUT0_W::new(self)
    }
    #[doc = "Bit 1 - P6OUT1"]
    #[inline(always)]
    #[must_use]
    pub fn p6out1(&mut self) -> P6OUT1_W<1> {
        P6OUT1_W::new(self)
    }
    #[doc = "Bit 2 - P6OUT2"]
    #[inline(always)]
    #[must_use]
    pub fn p6out2(&mut self) -> P6OUT2_W<2> {
        P6OUT2_W::new(self)
    }
    #[doc = "Bit 3 - P6OUT3"]
    #[inline(always)]
    #[must_use]
    pub fn p6out3(&mut self) -> P6OUT3_W<3> {
        P6OUT3_W::new(self)
    }
    #[doc = "Bit 4 - P6OUT4"]
    #[inline(always)]
    #[must_use]
    pub fn p6out4(&mut self) -> P6OUT4_W<4> {
        P6OUT4_W::new(self)
    }
    #[doc = "Bit 5 - P6OUT5"]
    #[inline(always)]
    #[must_use]
    pub fn p6out5(&mut self) -> P6OUT5_W<5> {
        P6OUT5_W::new(self)
    }
    #[doc = "Bit 6 - P6OUT6"]
    #[inline(always)]
    #[must_use]
    pub fn p6out6(&mut self) -> P6OUT6_W<6> {
        P6OUT6_W::new(self)
    }
    #[doc = "Bit 7 - P6OUT7"]
    #[inline(always)]
    #[must_use]
    pub fn p6out7(&mut self) -> P6OUT7_W<7> {
        P6OUT7_W::new(self)
    }
