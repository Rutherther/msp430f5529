...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p6ds0(&mut self) -> P6DS0_W<0> {
        P6DS0_W::new(self)
    }
    #[doc = "Bit 1 - P6DS1"]
    #[inline(always)]
    #[must_use]
    pub fn p6ds1(&mut self) -> P6DS1_W<1> {
        P6DS1_W::new(self)
    }
    #[doc = "Bit 2 - P6DS2"]
    #[inline(always)]
    #[must_use]
    pub fn p6ds2(&mut self) -> P6DS2_W<2> {
        P6DS2_W::new(self)
    }
    #[doc = "Bit 3 - P6DS3"]
    #[inline(always)]
    #[must_use]
    pub fn p6ds3(&mut self) -> P6DS3_W<3> {
        P6DS3_W::new(self)
    }
    #[doc = "Bit 4 - P6DS4"]
    #[inline(always)]
    #[must_use]
    pub fn p6ds4(&mut self) -> P6DS4_W<4> {
        P6DS4_W::new(self)
    }
    #[doc = "Bit 5 - P6DS5"]
    #[inline(always)]
    #[must_use]
    pub fn p6ds5(&mut self) -> P6DS5_W<5> {
        P6DS5_W::new(self)
    }
    #[doc = "Bit 6 - P6DS6"]
    #[inline(always)]
    #[must_use]
    pub fn p6ds6(&mut self) -> P6DS6_W<6> {
        P6DS6_W::new(self)
    }
    #[doc = "Bit 7 - P6DS7"]
    #[inline(always)]
    #[must_use]
    pub fn p6ds7(&mut self) -> P6DS7_W<7> {
        P6DS7_W::new(self)
    }
