...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p5dir0(&mut self) -> P5DIR0_W<0> {
        P5DIR0_W::new(self)
    }
    #[doc = "Bit 1 - P5DIR1"]
    #[inline(always)]
    #[must_use]
    pub fn p5dir1(&mut self) -> P5DIR1_W<1> {
        P5DIR1_W::new(self)
    }
    #[doc = "Bit 2 - P5DIR2"]
    #[inline(always)]
    #[must_use]
    pub fn p5dir2(&mut self) -> P5DIR2_W<2> {
        P5DIR2_W::new(self)
    }
    #[doc = "Bit 3 - P5DIR3"]
    #[inline(always)]
    #[must_use]
    pub fn p5dir3(&mut self) -> P5DIR3_W<3> {
        P5DIR3_W::new(self)
    }
    #[doc = "Bit 4 - P5DIR4"]
    #[inline(always)]
    #[must_use]
    pub fn p5dir4(&mut self) -> P5DIR4_W<4> {
        P5DIR4_W::new(self)
    }
    #[doc = "Bit 5 - P5DIR5"]
    #[inline(always)]
    #[must_use]
    pub fn p5dir5(&mut self) -> P5DIR5_W<5> {
        P5DIR5_W::new(self)
    }
    #[doc = "Bit 6 - P5DIR6"]
    #[inline(always)]
    #[must_use]
    pub fn p5dir6(&mut self) -> P5DIR6_W<6> {
        P5DIR6_W::new(self)
    }
    #[doc = "Bit 7 - P5DIR7"]
    #[inline(always)]
    #[must_use]
    pub fn p5dir7(&mut self) -> P5DIR7_W<7> {
        P5DIR7_W::new(self)
    }
