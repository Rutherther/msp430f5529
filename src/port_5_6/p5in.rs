...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p5in0(&mut self) -> P5IN0_W<0> {
        P5IN0_W::new(self)
    }
    #[doc = "Bit 1 - P5IN1"]
    #[inline(always)]
    #[must_use]
    pub fn p5in1(&mut self) -> P5IN1_W<1> {
        P5IN1_W::new(self)
    }
    #[doc = "Bit 2 - P5IN2"]
    #[inline(always)]
    #[must_use]
    pub fn p5in2(&mut self) -> P5IN2_W<2> {
        P5IN2_W::new(self)
    }
    #[doc = "Bit 3 - P5IN3"]
    #[inline(always)]
    #[must_use]
    pub fn p5in3(&mut self) -> P5IN3_W<3> {
        P5IN3_W::new(self)
    }
    #[doc = "Bit 4 - P5IN4"]
    #[inline(always)]
    #[must_use]
    pub fn p5in4(&mut self) -> P5IN4_W<4> {
        P5IN4_W::new(self)
    }
    #[doc = "Bit 5 - P5IN5"]
    #[inline(always)]
    #[must_use]
    pub fn p5in5(&mut self) -> P5IN5_W<5> {
        P5IN5_W::new(self)
    }
    #[doc = "Bit 6 - P5IN6"]
    #[inline(always)]
    #[must_use]
    pub fn p5in6(&mut self) -> P5IN6_W<6> {
        P5IN6_W::new(self)
    }
    #[doc = "Bit 7 - P5IN7"]
    #[inline(always)]
    #[must_use]
    pub fn p5in7(&mut self) -> P5IN7_W<7> {
        P5IN7_W::new(self)
    }
