...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p7dir0(&mut self) -> P7DIR0_W<0> {
        P7DIR0_W::new(self)
    }
    #[doc = "Bit 1 - P7DIR1"]
    #[inline(always)]
    #[must_use]
    pub fn p7dir1(&mut self) -> P7DIR1_W<1> {
        P7DIR1_W::new(self)
    }
    #[doc = "Bit 2 - P7DIR2"]
    #[inline(always)]
    #[must_use]
    pub fn p7dir2(&mut self) -> P7DIR2_W<2> {
        P7DIR2_W::new(self)
    }
    #[doc = "Bit 3 - P7DIR3"]
    #[inline(always)]
    #[must_use]
    pub fn p7dir3(&mut self) -> P7DIR3_W<3> {
        P7DIR3_W::new(self)
    }
    #[doc = "Bit 4 - P7DIR4"]
    #[inline(always)]
    #[must_use]
    pub fn p7dir4(&mut self) -> P7DIR4_W<4> {
        P7DIR4_W::new(self)
    }
    #[doc = "Bit 5 - P7DIR5"]
    #[inline(always)]
    #[must_use]
    pub fn p7dir5(&mut self) -> P7DIR5_W<5> {
        P7DIR5_W::new(self)
    }
    #[doc = "Bit 6 - P7DIR6"]
    #[inline(always)]
    #[must_use]
    pub fn p7dir6(&mut self) -> P7DIR6_W<6> {
        P7DIR6_W::new(self)
    }
    #[doc = "Bit 7 - P7DIR7"]
    #[inline(always)]
    #[must_use]
    pub fn p7dir7(&mut self) -> P7DIR7_W<7> {
        P7DIR7_W::new(self)
    }
