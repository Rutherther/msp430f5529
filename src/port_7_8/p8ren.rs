...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p8ren0(&mut self) -> P8REN0_W<0> {
        P8REN0_W::new(self)
    }
    #[doc = "Bit 1 - P8REN1"]
    #[inline(always)]
    #[must_use]
    pub fn p8ren1(&mut self) -> P8REN1_W<1> {
        P8REN1_W::new(self)
    }
    #[doc = "Bit 2 - P8REN2"]
    #[inline(always)]
    #[must_use]
    pub fn p8ren2(&mut self) -> P8REN2_W<2> {
        P8REN2_W::new(self)
    }
    #[doc = "Bit 3 - P8REN3"]
    #[inline(always)]
    #[must_use]
    pub fn p8ren3(&mut self) -> P8REN3_W<3> {
        P8REN3_W::new(self)
    }
    #[doc = "Bit 4 - P8REN4"]
    #[inline(always)]
    #[must_use]
    pub fn p8ren4(&mut self) -> P8REN4_W<4> {
        P8REN4_W::new(self)
    }
    #[doc = "Bit 5 - P8REN5"]
    #[inline(always)]
    #[must_use]
    pub fn p8ren5(&mut self) -> P8REN5_W<5> {
        P8REN5_W::new(self)
    }
    #[doc = "Bit 6 - P8REN6"]
    #[inline(always)]
    #[must_use]
    pub fn p8ren6(&mut self) -> P8REN6_W<6> {
        P8REN6_W::new(self)
    }
    #[doc = "Bit 7 - P8REN7"]
    #[inline(always)]
    #[must_use]
    pub fn p8ren7(&mut self) -> P8REN7_W<7> {
        P8REN7_W::new(self)
    }
