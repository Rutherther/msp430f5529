...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p8sel0(&mut self) -> P8SEL0_W<0> {
        P8SEL0_W::new(self)
    }
    #[doc = "Bit 1 - P8SEL1"]
    #[inline(always)]
    #[must_use]
    pub fn p8sel1(&mut self) -> P8SEL1_W<1> {
        P8SEL1_W::new(self)
    }
    #[doc = "Bit 2 - P8SEL2"]
    #[inline(always)]
    #[must_use]
    pub fn p8sel2(&mut self) -> P8SEL2_W<2> {
        P8SEL2_W::new(self)
    }
    #[doc = "Bit 3 - P8SEL3"]
    #[inline(always)]
    #[must_use]
    pub fn p8sel3(&mut self) -> P8SEL3_W<3> {
        P8SEL3_W::new(self)
    }
    #[doc = "Bit 4 - P8SEL4"]
    #[inline(always)]
    #[must_use]
    pub fn p8sel4(&mut self) -> P8SEL4_W<4> {
        P8SEL4_W::new(self)
    }
    #[doc = "Bit 5 - P8SEL5"]
    #[inline(always)]
    #[must_use]
    pub fn p8sel5(&mut self) -> P8SEL5_W<5> {
        P8SEL5_W::new(self)
    }
    #[doc = "Bit 6 - P8SEL6"]
    #[inline(always)]
    #[must_use]
    pub fn p8sel6(&mut self) -> P8SEL6_W<6> {
        P8SEL6_W::new(self)
    }
    #[doc = "Bit 7 - P8SEL7"]
    #[inline(always)]
    #[must_use]
    pub fn p8sel7(&mut self) -> P8SEL7_W<7> {
        P8SEL7_W::new(self)
    }
