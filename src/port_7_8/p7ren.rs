...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p7ren0(&mut self) -> P7REN0_W<0> {
        P7REN0_W::new(self)
    }
    #[doc = "Bit 1 - P7REN1"]
    #[inline(always)]
    #[must_use]
    pub fn p7ren1(&mut self) -> P7REN1_W<1> {
        P7REN1_W::new(self)
    }
    #[doc = "Bit 2 - P7REN2"]
    #[inline(always)]
    #[must_use]
    pub fn p7ren2(&mut self) -> P7REN2_W<2> {
        P7REN2_W::new(self)
    }
    #[doc = "Bit 3 - P7REN3"]
    #[inline(always)]
    #[must_use]
    pub fn p7ren3(&mut self) -> P7REN3_W<3> {
        P7REN3_W::new(self)
    }
    #[doc = "Bit 4 - P7REN4"]
    #[inline(always)]
    #[must_use]
    pub fn p7ren4(&mut self) -> P7REN4_W<4> {
        P7REN4_W::new(self)
    }
    #[doc = "Bit 5 - P7REN5"]
    #[inline(always)]
    #[must_use]
    pub fn p7ren5(&mut self) -> P7REN5_W<5> {
        P7REN5_W::new(self)
    }
    #[doc = "Bit 6 - P7REN6"]
    #[inline(always)]
    #[must_use]
    pub fn p7ren6(&mut self) -> P7REN6_W<6> {
        P7REN6_W::new(self)
    }
    #[doc = "Bit 7 - P7REN7"]
    #[inline(always)]
    #[must_use]
    pub fn p7ren7(&mut self) -> P7REN7_W<7> {
        P7REN7_W::new(self)
    }
