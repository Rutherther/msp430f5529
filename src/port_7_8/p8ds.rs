...
pub type P8DS0_R = crate::BitReader<bool>;
#[doc = "Field `P8DS0` writer - P8DS0"]
pub type P8DS0_W<'a, const O: u8> = crate::BitWriter<'a, u8, P8DS_SPEC, bool, O>;
#[doc = "Field `P8DS1` reader - P8DS1"]
pub type P8DS1_R = crate::BitReader<bool>;
#[doc = "Field `P8DS1` writer - P8DS1"]
pub type P8DS1_W<'a, const O: u8> = crate::BitWriter<'a, u8, P8DS_SPEC, bool, O>;
#[doc = "Field `P8DS2` reader - P8DS2"]
pub type P8DS2_R = crate::BitReader<bool>;
#[doc = "Field `P8DS2` writer - P8DS2"]
pub type P8DS2_W<'a, const O: u8> = crate::BitWriter<'a, u8, P8DS_SPEC, bool, O>;
#[doc = "Field `P8DS3` reader - P8DS3"]
pub type P8DS3_R = crate::BitReader<bool>;
#[doc = "Field `P8DS3` writer - P8DS3"]
pub type P8DS3_W<'a, const O: u8> = crate::BitWriter<'a, u8, P8DS_SPEC, bool, O>;
#[doc = "Field `P8DS4` reader - P8DS4"]
pub type P8DS4_R = crate::BitReader<bool>;
#[doc = "Field `P8DS4` writer - P8DS4"]
pub type P8DS4_W<'a, const O: u8> = crate::BitWriter<'a, u8, P8DS_SPEC, bool, O>;
#[doc = "Field `P8DS5` reader - P8DS5"]
pub type P8DS5_R = crate::BitReader<bool>;
#[doc = "Field `P8DS5` writer - P8DS5"]
pub type P8DS5_W<'a, const O: u8> = crate::BitWriter<'a, u8, P8DS_SPEC, bool, O>;
#[doc = "Field `P8DS6` reader - P8DS6"]
pub type P8DS6_R = crate::BitReader<bool>;
#[doc = "Field `P8DS6` writer - P8DS6"]
pub type P8DS6_W<'a, const O: u8> = crate::BitWriter<'a, u8, P8DS_SPEC, bool, O>;
#[doc = "Field `P8DS7` reader - P8DS7"]
pub type P8DS7_R = crate::BitReader<bool>;
#[doc = "Field `P8DS7` writer - P8DS7"]
pub type P8DS7_W<'a, const O: u8> = crate::BitWriter<'a, u8, P8DS_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - P8DS0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p8ds0(&mut self) -> P8DS0_W<0> {
        P8DS0_W::new(self)
    }
    #[doc = "Bit 1 - P8DS1"]
    #[inline(always)]
    #[must_use]
    pub fn p8ds1(&mut self) -> P8DS1_W<1> {
        P8DS1_W::new(self)
    }
    #[doc = "Bit 2 - P8DS2"]
    #[inline(always)]
    #[must_use]
    pub fn p8ds2(&mut self) -> P8DS2_W<2> {
        P8DS2_W::new(self)
    }
    #[doc = "Bit 3 - P8DS3"]
    #[inline(always)]
    #[must_use]
    pub fn p8ds3(&mut self) -> P8DS3_W<3> {
        P8DS3_W::new(self)
    }
    #[doc = "Bit 4 - P8DS4"]
    #[inline(always)]
    #[must_use]
    pub fn p8ds4(&mut self) -> P8DS4_W<4> {
        P8DS4_W::new(self)
    }
    #[doc = "Bit 5 - P8DS5"]
    #[inline(always)]
    #[must_use]
    pub fn p8ds5(&mut self) -> P8DS5_W<5> {
        P8DS5_W::new(self)
    }
    #[doc = "Bit 6 - P8DS6"]
    #[inline(always)]
    #[must_use]
    pub fn p8ds6(&mut self) -> P8DS6_W<6> {
        P8DS6_W::new(self)
    }
    #[doc = "Bit 7 - P8DS7"]
    #[inline(always)]
    #[must_use]
    pub fn p8ds7(&mut self) -> P8DS7_W<7> {
        P8DS7_W::new(self)
    }
