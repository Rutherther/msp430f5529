...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p8in0(&mut self) -> P8IN0_W<0> {
        P8IN0_W::new(self)
    }
    #[doc = "Bit 1 - P8IN1"]
    #[inline(always)]
    #[must_use]
    pub fn p8in1(&mut self) -> P8IN1_W<1> {
        P8IN1_W::new(self)
    }
    #[doc = "Bit 2 - P8IN2"]
    #[inline(always)]
    #[must_use]
    pub fn p8in2(&mut self) -> P8IN2_W<2> {
        P8IN2_W::new(self)
    }
    #[doc = "Bit 3 - P8IN3"]
    #[inline(always)]
    #[must_use]
    pub fn p8in3(&mut self) -> P8IN3_W<3> {
        P8IN3_W::new(self)
    }
    #[doc = "Bit 4 - P8IN4"]
    #[inline(always)]
    #[must_use]
    pub fn p8in4(&mut self) -> P8IN4_W<4> {
        P8IN4_W::new(self)
    }
    #[doc = "Bit 5 - P8IN5"]
    #[inline(always)]
    #[must_use]
    pub fn p8in5(&mut self) -> P8IN5_W<5> {
        P8IN5_W::new(self)
    }
    #[doc = "Bit 6 - P8IN6"]
    #[inline(always)]
    #[must_use]
    pub fn p8in6(&mut self) -> P8IN6_W<6> {
        P8IN6_W::new(self)
    }
    #[doc = "Bit 7 - P8IN7"]
    #[inline(always)]
    #[must_use]
    pub fn p8in7(&mut self) -> P8IN7_W<7> {
        P8IN7_W::new(self)
    }
