...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p7out0(&mut self) -> P7OUT0_W<0> {
        P7OUT0_W::new(self)
    }
    #[doc = "Bit 1 - P7OUT1"]
    #[inline(always)]
    #[must_use]
    pub fn p7out1(&mut self) -> P7OUT1_W<1> {
        P7OUT1_W::new(self)
    }
    #[doc = "Bit 2 - P7OUT2"]
    #[inline(always)]
    #[must_use]
    pub fn p7out2(&mut self) -> P7OUT2_W<2> {
        P7OUT2_W::new(self)
    }
    #[doc = "Bit 3 - P7OUT3"]
    #[inline(always)]
    #[must_use]
    pub fn p7out3(&mut self) -> P7OUT3_W<3> {
        P7OUT3_W::new(self)
    }
    #[doc = "Bit 4 - P7OUT4"]
    #[inline(always)]
    #[must_use]
    pub fn p7out4(&mut self) -> P7OUT4_W<4> {
        P7OUT4_W::new(self)
    }
    #[doc = "Bit 5 - P7OUT5"]
    #[inline(always)]
    #[must_use]
    pub fn p7out5(&mut self) -> P7OUT5_W<5> {
        P7OUT5_W::new(self)
    }
    #[doc = "Bit 6 - P7OUT6"]
    #[inline(always)]
    #[must_use]
    pub fn p7out6(&mut self) -> P7OUT6_W<6> {
        P7OUT6_W::new(self)
    }
    #[doc = "Bit 7 - P7OUT7"]
    #[inline(always)]
    #[must_use]
    pub fn p7out7(&mut self) -> P7OUT7_W<7> {
        P7OUT7_W::new(self)
    }
