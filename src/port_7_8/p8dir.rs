...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p8dir0(&mut self) -> P8DIR0_W<0> {
        P8DIR0_W::new(self)
    }
    #[doc = "Bit 1 - P8DIR1"]
    #[inline(always)]
    #[must_use]
    pub fn p8dir1(&mut self) -> P8DIR1_W<1> {
        P8DIR1_W::new(self)
    }
    #[doc = "Bit 2 - P8DIR2"]
    #[inline(always)]
    #[must_use]
    pub fn p8dir2(&mut self) -> P8DIR2_W<2> {
        P8DIR2_W::new(self)
    }
    #[doc = "Bit 3 - P8DIR3"]
    #[inline(always)]
    #[must_use]
    pub fn p8dir3(&mut self) -> P8DIR3_W<3> {
        P8DIR3_W::new(self)
    }
    #[doc = "Bit 4 - P8DIR4"]
    #[inline(always)]
    #[must_use]
    pub fn p8dir4(&mut self) -> P8DIR4_W<4> {
        P8DIR4_W::new(self)
    }
    #[doc = "Bit 5 - P8DIR5"]
    #[inline(always)]
    #[must_use]
    pub fn p8dir5(&mut self) -> P8DIR5_W<5> {
        P8DIR5_W::new(self)
    }
    #[doc = "Bit 6 - P8DIR6"]
    #[inline(always)]
    #[must_use]
    pub fn p8dir6(&mut self) -> P8DIR6_W<6> {
        P8DIR6_W::new(self)
    }
    #[doc = "Bit 7 - P8DIR7"]
    #[inline(always)]
    #[must_use]
    pub fn p8dir7(&mut self) -> P8DIR7_W<7> {
        P8DIR7_W::new(self)
    }
