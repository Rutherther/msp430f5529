...
pub type P7IN0_R = crate::BitReader<bool>;
#[doc = "Field `P7IN0` writer - P7IN0"]
pub type P7IN0_W<'a, const O: u8> = crate::BitWriter<'a, u8, P7IN_SPEC, bool, O>;
#[doc = "Field `P7IN1` reader - P7IN1"]
pub type P7IN1_R = crate::BitReader<bool>;
#[doc = "Field `P7IN1` writer - P7IN1"]
pub type P7IN1_W<'a, const O: u8> = crate::BitWriter<'a, u8, P7IN_SPEC, bool, O>;
#[doc = "Field `P7IN2` reader - P7IN2"]
pub type P7IN2_R = crate::BitReader<bool>;
#[doc = "Field `P7IN2` writer - P7IN2"]
pub type P7IN2_W<'a, const O: u8> = crate::BitWriter<'a, u8, P7IN_SPEC, bool, O>;
#[doc = "Field `P7IN3` reader - P7IN3"]
pub type P7IN3_R = crate::BitReader<bool>;
#[doc = "Field `P7IN3` writer - P7IN3"]
pub type P7IN3_W<'a, const O: u8> = crate::BitWriter<'a, u8, P7IN_SPEC, bool, O>;
#[doc = "Field `P7IN4` reader - P7IN4"]
pub type P7IN4_R = crate::BitReader<bool>;
#[doc = "Field `P7IN4` writer - P7IN4"]
pub type P7IN4_W<'a, const O: u8> = crate::BitWriter<'a, u8, P7IN_SPEC, bool, O>;
#[doc = "Field `P7IN5` reader - P7IN5"]
pub type P7IN5_R = crate::BitReader<bool>;
#[doc = "Field `P7IN5` writer - P7IN5"]
pub type P7IN5_W<'a, const O: u8> = crate::BitWriter<'a, u8, P7IN_SPEC, bool, O>;
#[doc = "Field `P7IN6` reader - P7IN6"]
pub type P7IN6_R = crate::BitReader<bool>;
#[doc = "Field `P7IN6` writer - P7IN6"]
pub type P7IN6_W<'a, const O: u8> = crate::BitWriter<'a, u8, P7IN_SPEC, bool, O>;
#[doc = "Field `P7IN7` reader - P7IN7"]
pub type P7IN7_R = crate::BitReader<bool>;
#[doc = "Field `P7IN7` writer - P7IN7"]
pub type P7IN7_W<'a, const O: u8> = crate::BitWriter<'a, u8, P7IN_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - P7IN0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p7in0(&mut self) -> P7IN0_W<0> {
        P7IN0_W::new(self)
    }
    #[doc = "Bit 1 - P7IN1"]
    #[inline(always)]
    #[must_use]
    pub fn p7in1(&mut self) -> P7IN1_W<1> {
        P7IN1_W::new(self)
    }
    #[doc = "Bit 2 - P7IN2"]
    #[inline(always)]
    #[must_use]
    pub fn p7in2(&mut self) -> P7IN2_W<2> {
        P7IN2_W::new(self)
    }
    #[doc = "Bit 3 - P7IN3"]
    #[inline(always)]
    #[must_use]
    pub fn p7in3(&mut self) -> P7IN3_W<3> {
        P7IN3_W::new(self)
    }
    #[doc = "Bit 4 - P7IN4"]
    #[inline(always)]
    #[must_use]
    pub fn p7in4(&mut self) -> P7IN4_W<4> {
        P7IN4_W::new(self)
    }
    #[doc = "Bit 5 - P7IN5"]
    #[inline(always)]
    #[must_use]
    pub fn p7in5(&mut self) -> P7IN5_W<5> {
        P7IN5_W::new(self)
    }
    #[doc = "Bit 6 - P7IN6"]
    #[inline(always)]
    #[must_use]
    pub fn p7in6(&mut self) -> P7IN6_W<6> {
        P7IN6_W::new(self)
    }
    #[doc = "Bit 7 - P7IN7"]
    #[inline(always)]
    #[must_use]
    pub fn p7in7(&mut self) -> P7IN7_W<7> {
        P7IN7_W::new(self)
    }
