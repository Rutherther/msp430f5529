...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p8out0(&mut self) -> P8OUT0_W<0> {
        P8OUT0_W::new(self)
    }
    #[doc = "Bit 1 - P8OUT1"]
    #[inline(always)]
    #[must_use]
    pub fn p8out1(&mut self) -> P8OUT1_W<1> {
        P8OUT1_W::new(self)
    }
    #[doc = "Bit 2 - P8OUT2"]
    #[inline(always)]
    #[must_use]
    pub fn p8out2(&mut self) -> P8OUT2_W<2> {
        P8OUT2_W::new(self)
    }
    #[doc = "Bit 3 - P8OUT3"]
    #[inline(always)]
    #[must_use]
    pub fn p8out3(&mut self) -> P8OUT3_W<3> {
        P8OUT3_W::new(self)
    }
    #[doc = "Bit 4 - P8OUT4"]
    #[inline(always)]
    #[must_use]
    pub fn p8out4(&mut self) -> P8OUT4_W<4> {
        P8OUT4_W::new(self)
    }
    #[doc = "Bit 5 - P8OUT5"]
    #[inline(always)]
    #[must_use]
    pub fn p8out5(&mut self) -> P8OUT5_W<5> {
        P8OUT5_W::new(self)
    }
    #[doc = "Bit 6 - P8OUT6"]
    #[inline(always)]
    #[must_use]
    pub fn p8out6(&mut self) -> P8OUT6_W<6> {
        P8OUT6_W::new(self)
    }
    #[doc = "Bit 7 - P8OUT7"]
    #[inline(always)]
    #[must_use]
    pub fn p8out7(&mut self) -> P8OUT7_W<7> {
        P8OUT7_W::new(self)
    }
