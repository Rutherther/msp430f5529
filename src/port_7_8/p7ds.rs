...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn p7ds0(&mut self) -> P7DS0_W<0> {
        P7DS0_W::new(self)
    }
    #[doc = "Bit 1 - P7DS1"]
    #[inline(always)]
    #[must_use]
    pub fn p7ds1(&mut self) -> P7DS1_W<1> {
        P7DS1_W::new(self)
    }
    #[doc = "Bit 2 - P7DS2"]
    #[inline(always)]
    #[must_use]
    pub fn p7ds2(&mut self) -> P7DS2_W<2> {
        P7DS2_W::new(self)
    }
    #[doc = "Bit 3 - P7DS3"]
    #[inline(always)]
    #[must_use]
    pub fn p7ds3(&mut self) -> P7DS3_W<3> {
        P7DS3_W::new(self)
    }
    #[doc = "Bit 4 - P7DS4"]
    #[inline(always)]
    #[must_use]
    pub fn p7ds4(&mut self) -> P7DS4_W<4> {
        P7DS4_W::new(self)
    }
    #[doc = "Bit 5 - P7DS5"]
    #[inline(always)]
    #[must_use]
    pub fn p7ds5(&mut self) -> P7DS5_W<5> {
        P7DS5_W::new(self)
    }
    #[doc = "Bit 6 - P7DS6"]
    #[inline(always)]
    #[must_use]
    pub fn p7ds6(&mut self) -> P7DS6_W<6> {
        P7DS6_W::new(self)
    }
    #[doc = "Bit 7 - P7DS7"]
    #[inline(always)]
    #[must_use]
    pub fn p7ds7(&mut self) -> P7DS7_W<7> {
        P7DS7_W::new(self)
    }
