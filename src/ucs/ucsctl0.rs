...
pub type MOD0_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCSCTL0_SPEC, bool, O>;
...
pub type MOD1_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCSCTL0_SPEC, bool, O>;
...
pub type MOD2_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCSCTL0_SPEC, bool, O>;
...
pub type MOD3_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCSCTL0_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mod0(&mut self) -> MOD0_W<3> {
        MOD0_W::new(self)
    }
    #[doc = "Bit 4 - Modulation Bit Counter Bit : 1"]
    #[inline(always)]
    #[must_use]
    pub fn mod1(&mut self) -> MOD1_W<4> {
        MOD1_W::new(self)
    }
    #[doc = "Bit 5 - Modulation Bit Counter Bit : 2"]
    #[inline(always)]
    #[must_use]
    pub fn mod2(&mut self) -> MOD2_W<5> {
        MOD2_W::new(self)
    }
    #[doc = "Bit 6 - Modulation Bit Counter Bit : 3"]
    #[inline(always)]
    #[must_use]
    pub fn mod3(&mut self) -> MOD3_W<6> {
        MOD3_W::new(self)
    }
    #[doc = "Bit 7 - Modulation Bit Counter Bit : 4"]
    #[inline(always)]
    #[must_use]
    pub fn mod4(&mut self) -> MOD4_W<7> {
        MOD4_W::new(self)
    }
    #[doc = "Bit 8 - DCO TAP Bit : 0"]
    #[inline(always)]
    #[must_use]
    pub fn dco0(&mut self) -> DCO0_W<8> {
        DCO0_W::new(self)
    }
    #[doc = "Bit 9 - DCO TAP Bit : 1"]
    #[inline(always)]
    #[must_use]
    pub fn dco1(&mut self) -> DCO1_W<9> {
        DCO1_W::new(self)
    }
    #[doc = "Bit 10 - DCO TAP Bit : 2"]
    #[inline(always)]
    #[must_use]
    pub fn dco2(&mut self) -> DCO2_W<10> {
        DCO2_W::new(self)
    }
    #[doc = "Bit 11 - DCO TAP Bit : 3"]
    #[inline(always)]
    #[must_use]
    pub fn dco3(&mut self) -> DCO3_W<11> {
        DCO3_W::new(self)
    }
    #[doc = "Bit 12 - DCO TAP Bit : 4"]
    #[inline(always)]
    #[must_use]
    pub fn dco4(&mut self) -> DCO4_W<12> {
        DCO4_W::new(self)
    }
