...
pub type UCRXIFG_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0IFG_SPI_SPEC, bool, O>;
...
pub type UCTXIFG_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCB0IFG_SPI_SPEC, bool, O>;
impl R {
