...
pub type SVSMLRRL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, SVSMLCTL_SPEC, u8, SVSMLRRL_A, 3, O>;
impl<'a, const O: u8> SVSMLRRL_W<'a, O> {
...
pub type SVSMLDLYST_W<'a, const O: u8> = crate::BitWriter<'a, u16, SVSMLCTL_SPEC, bool, O>;
#[doc = "Field `SVSLMD` reader - SVS low side mode"]
pub type SVSLMD_R = crate::BitReader<bool>;
#[doc = "Field `SVSLMD` writer - SVS low side mode"]
pub type SVSLMD_W<'a, const O: u8> = crate::BitWriter<'a, u16, SVSMLCTL_SPEC, bool, O>;
...
pub type SVSMLEVM_W<'a, const O: u8> = crate::BitWriter<'a, u16, SVSMLCTL_SPEC, bool, O>;
...
pub type SVSMLACE_W<'a, const O: u8> = crate::BitWriter<'a, u16, SVSMLCTL_SPEC, bool, O>;
...
pub type SVSLRVL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u16, SVSMLCTL_SPEC, u8, SVSLRVL_A, 2, O>;
impl<'a, const O: u8> SVSLRVL_W<'a, O> {
...
pub type SVSLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, SVSMLCTL_SPEC, bool, O>;
...
pub type SVSLFP_W<'a, const O: u8> = crate::BitWriter<'a, u16, SVSMLCTL_SPEC, bool, O>;
...
pub type SVMLOVPE_W<'a, const O: u8> = crate::BitWriter<'a, u16, SVSMLCTL_SPEC, bool, O>;
...
pub type SVMLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, SVSMLCTL_SPEC, bool, O>;
...
pub type SVMLFP_W<'a, const O: u8> = crate::BitWriter<'a, u16, SVSMLCTL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn svsmlrrl(&mut self) -> SVSMLRRL_W<0> {
        SVSMLRRL_W::new(self)
    }
    #[doc = "Bit 3 - SVS and SVM low side delay status"]
    #[inline(always)]
    #[must_use]
    pub fn svsmldlyst(&mut self) -> SVSMLDLYST_W<3> {
        SVSMLDLYST_W::new(self)
    }
    #[doc = "Bit 4 - SVS low side mode"]
    #[inline(always)]
    #[must_use]
    pub fn svslmd(&mut self) -> SVSLMD_W<4> {
        SVSLMD_W::new(self)
    }
    #[doc = "Bit 6 - SVS and SVM low side event mask"]
    #[inline(always)]
    #[must_use]
    pub fn svsmlevm(&mut self) -> SVSMLEVM_W<6> {
        SVSMLEVM_W::new(self)
    }
    #[doc = "Bit 7 - SVS and SVM low side auto control enable"]
    #[inline(always)]
    #[must_use]
    pub fn svsmlace(&mut self) -> SVSMLACE_W<7> {
        SVSMLACE_W::new(self)
    }
    #[doc = "Bits 8:9 - SVS low side reset voltage level Bit: 0"]
    #[inline(always)]
    #[must_use]
    pub fn svslrvl(&mut self) -> SVSLRVL_W<8> {
        SVSLRVL_W::new(self)
    }
    #[doc = "Bit 10 - SVS low side enable"]
    #[inline(always)]
    #[must_use]
    pub fn svsle(&mut self) -> SVSLE_W<10> {
        SVSLE_W::new(self)
    }
    #[doc = "Bit 11 - SVS low side full performace mode"]
    #[inline(always)]
    #[must_use]
    pub fn svslfp(&mut self) -> SVSLFP_W<11> {
        SVSLFP_W::new(self)
    }
    #[doc = "Bit 12 - SVM low side over-voltage enable"]
    #[inline(always)]
    #[must_use]
    pub fn svmlovpe(&mut self) -> SVMLOVPE_W<12> {
        SVMLOVPE_W::new(self)
    }
    #[doc = "Bit 14 - SVM low side enable"]
    #[inline(always)]
    #[must_use]
    pub fn svmle(&mut self) -> SVMLE_W<14> {
        SVMLE_W::new(self)
    }
    #[doc = "Bit 15 - SVM low side full performace mode"]
    #[inline(always)]
    #[must_use]
    pub fn svmlfp(&mut self) -> SVMLFP_W<15> {
        SVMLFP_W::new(self)
    }
